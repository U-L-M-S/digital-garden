---
{"dg-publish":true,"permalink":"/02-resources/notes/uml-klassendiagramm/","tags":["ausbildung/gfn/ap1/vorbereitung","uml/klassendiagramm"],"noteIcon":"","updated":"2025-11-10T14:33:18.016+01:00"}
---
...
>[!example] Prüfungsaufgabe: Online-Shop-System
>**Szenario:** Ein Online-Shop soll entwickelt werden. Folgende Anforderungen sind gegeben:
>- Kunden können mehrere Bestellungen aufgeben
>- Eine Bestellung enthält mindestens einen Artikel
>- Artikel haben Preis, Name und Beschreibung
>- Es gibt physische Produkte (mit Gewicht) und digitale Produkte (mit Download-URL)
>- Kunden haben Adresse, Name und Kundennummer
>- Bestellungen haben Status (neu, bezahlt, versendet)
>
>**Aufgabe:**
>1. Erstellen Sie ein vollständiges Klassendiagramm
>2. Zeigen Sie alle Beziehungen (Assoziationen, Vererbung, Aggregation/Komposition)
>3. Markieren Sie Kardinalitäten
>4. Zeigen Sie Attribute und wichtige Methoden

---

# 🍳 Kochrezept: Klassendiagramm in 7 Schritten (Visuell)

```
┌─────────────────────────────────────────────────────────┐
│ SCHRITT 1: SUBSTANTIVE MARKIEREN (= KLASSEN)            │
├─────────────────────────────────────────────────────────┤
│ Lies die Aufgabe und unterstreiche alle Substantive:    │
│ Kunde, Bestellung, Artikel, Produkt, Adresse, Status   │
│                                                          │
│ 📌 TIPP: Nicht jedes Substantiv wird eine Klasse!       │
│    → Status = Attribut, nicht eigene Klasse            │
└─────────────────────────────────────────────────────────┘
          ↓
┌─────────────────────────────────────────────────────────┐
│ SCHRITT 2: KLASSEN-RECHTECKE ZEICHNEN                   │
├─────────────────────────────────────────────────────────┤
│        ┌─────────────┐                                  │
│        │   Kunde     │                                  │
│        ├─────────────┤                                  │
...
│        └─────────────┘                                  │
│                                                          │
│ 📌 MERKE: 3 Bereiche = Name / Attribute / Methoden      │
└─────────────────────────────────────────────────────────┘
          ↓
┌─────────────────────────────────────────────────────────┐
│ SCHRITT 3: ATTRIBUTE EINTRAGEN                          │
├─────────────────────────────────────────────────────────┤
│ Suche in der Aufgabe nach "haben", "besitzen":          │
│                                                          │
│        ┌──────────────────────────┐                     │
│        │      Kunde               │                     │
│        ├──────────────────────────┤                     │
...
└─────────────────────────────────────────────────────────┘
          ↓
┌─────────────────────────────────────────────────────────┐
│ SCHRITT 4: VERERBUNG ERKENNEN (IST-EIN-Beziehung)       │
├─────────────────────────────────────────────────────────┤
│ Suche nach "ist ein", "Art von", "Spezialisierung":     │
│                                                          │
│           ┌──────────────┐                              │
│           │   Artikel    │                              │
│           └──────┬───────┘                              │
│                  │ △  (leerer Pfeil = Vererbung)        │
│         ┌────────┴────────┐                             │
│         │                 │                             │
│  ┌──────▽─────┐   ┌──────▽────────┐                    │
│  │ Physisches │   │  Digitales    │                    │
│  │  Produkt   │   │   Produkt     │                    │
│  └────────────┘   └───────────────┘                    │
│                                                          │
│ 📌 REGEL: Spezifisches zeigt auf Allgemeines            │
└─────────────────────────────────────────────────────────┘
          ↓
┌─────────────────────────────────────────────────────────┐
│ SCHRITT 5: ASSOZIATIONEN (HAT-EINE-Beziehung)           │
├─────────────────────────────────────────────────────────┤
│ Suche nach "hat", "enthält", "gehört zu":               │
│                                                          │
│  Kunde ────────────── Bestellung                        │
│       1        *                                         │
│  (Kunde HAT mehrere Bestellungen)                       │
│                                                          │
│ 📌 KARDINALITÄTEN:                                       │
│    1 = genau einer                                       │
│    * = beliebig viele                                    │
...
└─────────────────────────────────────────────────────────┘
          ↓
┌─────────────────────────────────────────────────────────┐
│ SCHRITT 6: AGGREGATION vs KOMPOSITION                   │
├─────────────────────────────────────────────────────────┤
│                                                          │
│ AGGREGATION (leere Raute) ◇──── "kann ohne existieren"  │
│   Auto ◇──── Motor (Motor kann auch außerhalb leben)    │
│                                                          │
│ KOMPOSITION (volle Raute) ◆──── "stirbt zusammen"       │
│   Haus ◆──── Zimmer (Zimmer existiert nur im Haus)      │
│                                                          │
│ 📌 FRAGE: Kann B ohne A existieren?                     │
│    JA → Aggregation ◇                                    │
│    NEIN → Komposition ◆                                  │
└─────────────────────────────────────────────────────────┘
          ↓
┌─────────────────────────────────────────────────────────┐
│ SCHRITT 7: METHODEN HINZUFÜGEN                           │
├─────────────────────────────────────────────────────────┤
│ Überlege: Was MACHT diese Klasse?                       │
│                                                          │
│        ┌──────────────────────────────┐                 │
│        │      Bestellung              │                 │
│        ├──────────────────────────────┤                 │
...
│        │ - status: String             │                 │
│        ├──────────────────────────────┤                 │
│        │ + berechneGesamtpreis(): int │                 │
│        │ + versendeBestellung(): void │                 │
│        └──────────────────────────────┘                 │
│                                                          │
│ 📌 FORMAT: [Sichtbarkeit] name(Parameter): Rückgabetyp  │
└─────────────────────────────────────────────────────────┘
```
...
>- [ ] Alle wichtigen Klassen identifiziert?
>- [ ] Attribute mit Datentypen versehen?
>- [ ] Sichtbarkeiten (+, -, #) eingetragen?
>- [ ] Vererbungsbeziehungen mit △-Pfeil?
>- [ ] Kardinalitäten bei allen Assoziationen?
>- [ ] Aggregation/Komposition korrekt unterschieden?
>- [ ] Mindestens 2-3 sinnvolle Methoden pro Klasse?

>[!failure] Häufige Fehler
>❌ Kardinalitäten vertauscht (auf falscher Seite)
>❌ Vererbungspfeil zeigt in falsche Richtung
>❌ Aggregation statt Komposition (oder umgekehrt)
>❌ Methoden ohne Rückgabetyp
>❌ Attribute ohne Sichtbarkeit