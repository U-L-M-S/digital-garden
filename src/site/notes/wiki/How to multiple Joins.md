---
{"dg-publish":true,"permalink":"/wiki/how-to-multiple-joins/","tags":["informatik/datenbank","ausbildung/pruefung"],"noteIcon":"","updated":"2026-07-19T03:56:26.000+02:00","dg-note-properties":{"tags":["informatik/datenbank","ausbildung/pruefung"],"aliases":null,"links":null,"created_date":"2026-04-23"}}
---

> Systematische 4-Schritte-Methode, um [[wiki/SQL\|SQL]]-Abfragen mit mehreren (3+) Tabellen sauber aufzubauen.
>> Besonders relevant für [[wiki/IHK\|IHK]]-Prüfungsaufgaben, in denen 3–5 Tabellen über [[wiki/Foreign Key\|Fremdschlüssel]] verkettet sind und eine Aggregation pro Haupt-Entität gefordert wird.
...
| `Kunde`         | `Name` aus [[wiki/Kunden\|Kunden]]               |
...
- SQL [[wiki/INNER JOIN\|INNER JOIN]]
- SQL [[wiki/LEFT JOIN\|LEFT JOIN]]
- [[wiki/SQL GROUP BY\|SQL GROUP BY]] Regel
- [[wiki/SQL\|SQL]] Klausel-Reihenfolge
- [[wiki/SQL\|SQL]] Alias AS
- [[wiki/SQL JOIN\|SQL JOIN]] vs Kartesisches Produkt
- [[wiki/Foreign Key\|Fremdschlüssel]]
- Relationenmodell