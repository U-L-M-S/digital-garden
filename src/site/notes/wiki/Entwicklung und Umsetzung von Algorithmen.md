---
{"dg-publish":true,"permalink":"/wiki/entwicklung-und-umsetzung-von-algorithmen/","tags":["ausbildung/pruefung"],"noteIcon":"","updated":"2026-07-19T03:56:26.994+02:00","dg-note-properties":{"tags":["ausbildung/pruefung"],"aliases":null,"links":null,"created_date":"2025-11-06"}}
---


>Dieser Teil dauert ebenfalls 90 Minuten und umfasst 100 Punkte (10%).
>>Hier geht es um die praktische Programmierung - Algorithmen, [[wiki/SQL\|SQL]], [[wiki/OOP\|OOP]] und Testing.
___

## [[wiki/SQL\|SQL]] - Strukturierte Datenbankabfragen
>[[wiki/SQL\|SQL]] ist die Sprache, um mit [[wiki/Datenbank\|Datenbank]]en zu kommunizieren - unverzichtbar für jeden Entwickler.
...
#### [[wiki/SQL CREATE\|SQL CREATE]] TABLE
>Erstellt eine neue Tabelle in der [[wiki/Datenbank\|Datenbank]].
...
#### [[wiki/SQL ALTER\|SQL ALTER]] TABLE
...
#### [[wiki/SQL SELECT\|SQL SELECT]] - Die Basis
>Holt Daten aus der [[wiki/Datenbank\|Datenbank]].
...
#### [[wiki/SQL WHERE\|SQL WHERE]] - Filtern
...
#### [[wiki/SQL JOIN\|SQL JOIN]] - Tabellen verbinden
...
#### [[wiki/SQL GROUP BY\|SQL GROUP BY]] - Gruppieren
...
#### [[wiki/SQL HAVING\|SQL HAVING]] - Gruppierungen filtern
...
>Ein [[wiki/Algorithmus\|Algorithmus]] ist eine Schritt-für-Schritt-Anleitung zur Lösung eines Problems.

### Eigenschaften eines guten [[wiki/Algorithmus\|Algorithmus]]:
- **Korrektheit** - Liefert das richtige Ergebnis
- **Effizienz** - Braucht wenig Zeit und [[wiki/Speicher\|Speicher]]
...
- **Average Case:** [[wiki/6. Big O(n²)\|O(n²)]]
- **Worst Case:** [[wiki/6. Big O(n²)\|O(n²)]]
...
**Komplexität:**
- **Best/Average/Worst Case:** [[wiki/6. Big O(n²)\|O(n²)]]
...
**Komplexität:**
- **Best Case:** [[3. Big O(n)\|O(n)]] - bereits sortiert
- **Average/Worst Case:** [[wiki/6. Big O(n²)\|O(n²)]]
...
>Beschreibt, wie langsam ein [[wiki/Algorithmus\|Algorithmus]] wird, wenn Daten größer werden.

### Die wichtigsten Komplexitäten:

| Notation | Name | Beispiel | Beschreibung |
|----------|------|----------|--------------|
| [[1. Big O(1)\|O(1)]] | Konstant | Array-Zugriff | Immer gleich schnell |
| [[4. Big O(log n)\|O(log n)]] | Logarithmisch | Binäre Suche | Sehr effizient |
| [[3. Big O(n)\|O(n)]] | Linear | Lineare Suche | Proportional zur Größe |
| [[wiki/5. Big O(n log n)\|O(n log n)]] | Quasi-Linear | [[wiki/Quicksort\|Quicksort]], Mergesort | Gute Sortierung |
| [[wiki/6. Big O(n²)\|O(n²)]] | Quadratisch | [[wiki/Bubble Sort\|Bubble Sort]] | Langsam bei großen Daten |
...
## [[wiki/OOP\|OOP]] - Objektorientierte Programmierung
>[[wiki/OOP\|OOP]] organisiert Code in Objekten - jedes Objekt hat Daten und Funktionen.

### Die 4 Säulen der [[wiki/OOP\|OOP]]:

#### [[wiki/Kapselung\|Kapselung]]
...
#### [[wiki/Polymorphie\|Polymorphie]]
>Ein [[wiki/Java Interface\|Interface]], viele Formen - gleicher Aufruf, unterschiedliches Verhalten.
...
### [[wiki/Black Box Test\|Black Box Test]]
...
### [[wiki/White Box Test\|White Box Test]]
...
### [[wiki/Last- und Performancetest\|Last-/Performancetests]]
>Testen wie System unter Last reagiert.

**Was wird getestet:**
- Antwortzeiten unter Last
- Maximale Nutzerzahl
- [[wiki/Speicher\|Speicher]]-Verbrauch
- [[wiki/CPU\|CPU]]-Auslastung
...
**Vorteile:**
- Sehr schneller Zugriff [[1. Big O(1)\|O(1)]]
- Wenig [[wiki/Speicher\|Speicher]]-Overhead
...
## [[wiki/CPS\|Cyber-physische Systeme]]
>Verbindung zwischen [[wiki/Software\|Software]] und physischer Welt - [[wiki/Sensoren\|Sensoren]] und [[wiki/Aktoren\|Aktoren]].

🆕 **Neu für FIAE im Katalog 2025!**

### [[wiki/Sensoren\|Sensoren]]
...
>Wie oft sollen [[wiki/Sensoren\|Sensoren]] abgefragt werden?
...
### Was monitoren?
- **[[wiki/CPU\|CPU]]-Auslastung** - Ist der [[Prozessor\|Prozessor]] überlastet?
- **[[wiki/Speicher\|Speicher]]-Verbrauch** - Läuft der RAM voll?
...
**Beispiele:**
- **[[wiki/CPU\|CPU]] > 80%** für 5 Minuten → Warnung
- **[[wiki/Speicher\|Speicher]] > 90%** → Kritisch
