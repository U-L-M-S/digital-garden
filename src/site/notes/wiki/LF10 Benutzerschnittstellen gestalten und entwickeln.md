---
{"dg-publish":true,"permalink":"/wiki/lf-10-benutzerschnittstellen-gestalten-und-entwickeln/","tags":["GFN/LF10","status/in-progress"],"noteIcon":"","updated":"2026-07-02T12:18:59.095+02:00","dg-note-properties":{"tags":["GFN/LF10","status/in-progress"],"links":"https://lernplattform.gfn.de/course/view.php?id=14160","created_date":"2024-08-26"}}
---

> Du kannst gerne unter [meinem GitHub](https://github.com/U-L-M-S/digital-garden) mithelfen.

# I. [[wiki/User Interface\|User Interface]] - Die Verbindung zwischen Mensch und Maschine

---

> Stell dir vor, du willst mit einem Computer sprechen - aber ihr habt keine gemeinsame Sprache. Das [[wiki/User Interface\|User Interface]] ist der Übersetzer zwischen dir und der Maschine.

## Was ist ein [[wiki/User Interface\|User Interface]]?
...
## Die Evolution der [[wiki/User Interface\|Benutzeroberflächen]]

### Hardware [[wiki/User Interface\|User Interface]]
...
### Text-based [[wiki/User Interface\|User Interface]] (CLI)
...
### Menu-driven [[wiki/User Interface\|User Interface]]
...
### Graphical [[wiki/User Interface\|User Interface]] (GUI)
...
- Braucht viel [[wiki/Speicher\|Speicher]] und Rechenleistung
- Aufwändig zu programmieren

### Conversational [[wiki/User Interface\|User Interface]] (CUI)
...
### Virtual Reality [[wiki/User Interface\|User Interface]] (VRUI)
...
### Brain-Computer [[wiki/User Interface\|User Interface]] (BCI)
...
# II. [[wiki/Qualitätssicherung\|Qualitätssicherung]] - Wie gut ist gut genug?

---

> Stell dir vor, du kaufst ein Auto, aber die Bremsen funktionieren nur manchmal. [[wiki/Software\|Software]] ohne [[wiki/Qualitätssicherung\|Qualitätssicherung]] ist genauso gefährlich - nur meist weniger offensichtlich.

## Was bedeutet **Qualität** bei [[wiki/Software\|Software]]?

**Qualität** = [[wiki/Software\|Software]] erfüllt alle Anforderungen gut. Das heißt: Sie tut, was sie soll, und zwar **zuverlässig, sicher und benutzerfreundlich**.

### Warum ist das wichtig?

- Benutzer werden schnell frustriert
- Schlechte [[wiki/Software\|Software]] kostet Geld und Zeit
...
- [[wiki/Software\|Software]] rechnet, aber falsch
...
- Braucht wenig [[wiki/Speicher\|Speicher]] und [[wiki/CPU\|CPU]]
...
#### Komponententest ([[wiki/Unit Test\|Unit Test]])
...
- Funktionieren [[wiki/Motor\|Motor]] und Getriebe zusammen?
...
# III. [[wiki/UX\|User Experience]] - Wie fühlt sich Software an?

---

> Stell dir vor, du gehst in ein Restaurant. Das Essen ist gut, aber der Service ist schlecht, es ist laut und das Klo ist dreckig. Kommst du wieder? [[wiki/UX\|User Experience]] ist das Gesamterlebnis mit einem Produkt.

## Was ist [[wiki/UX\|User Experience]]?

**[[wiki/UX\|UX]]** ist **mehr als nur schönes Design**. Es ist das komplette Erlebnis: Wie fühlt sich die Nutzung an? Macht es Spaß? Ist es frustrierend? Erreiche ich meine Ziele?

### Das [[wiki/UX\|UX]]-Honeycomb - 7 Zutaten für gute [[wiki/UX\|UX]]:
...
#### Attraktive [[wiki/Software\|Software]] - DESIRABLE
...
#### Barrierefreie [[wiki/Software\|Software]] - ACCESSIBLE
...
#### Glaubwürdige [[wiki/Software\|Software]] - CREDIBLE
...
#### Hochwertige [[wiki/Software\|Software]] - VALUABLE
...
## Die 10 [[wiki/UX\|UX]]-Gestaltungsprinzipien
...
- **Buttons** immer an der gleichen [[wiki/Stelle\|Stelle]]
...
- **Anpassbarkeit**: Benutzer kann [[wiki/Java Interface\|Interface]] modifizieren
...
- **Kontexthilfe** direkt im [[wiki/Java Interface\|Interface]]
