---
{"dg-publish":true,"permalink":"/wiki/lamp-stack/","tags":["web","GFN/LF10/FISI","informatik/server"],"noteIcon":"","updated":"2025-10-29T12:59:07.000+01:00","dg-note-properties":{"tags":["web","GFN/LF10/FISI","informatik/server"],"aliases":["lAMP-Stack"],"links":null,"created_date":"2025-09-05"}}
---
...
# Was ist [[wiki/LAMP Stack\|LAMP Stack]]?
...
## Apache
> **Meist genutzter [[wiki/Server\|Server]] weltweit** – über 50% aller Internetseiten laufen über Apache!

- Nutzt [[wiki/HTTP\|HTTP]], um Anfragen zu bearbeiten und Informationen über das Internet zu versenden
...
## MySQL / MariaDB [[wiki/Datenbank\|Datenbank]]

![[LAMP-MySQL.png\|LAMP-MySQL.png]]

> **Relationale Open-Source [[wiki/Datenbank\|Datenbank]]** – das Gedächtnis deiner Website!

- **Einfaches Lagern** von Informationen
- **Einfaches Abrufen** der Informationen per [[wiki/SQL\|SQL]]
...
> **[[wiki/PHP\|PHP]]: Hypertext Preprocessor** – die Vermittlersprache zwischen Datenbank und Website!

- Eine [[Skriptsprache\|Skriptsprache]], die es ermöglicht, Daten aus der [[wiki/Datenbank\|Datenbank]] zu lesen und über [[HTML\|HTML]] weiterzugeben
- [[HTML\|HTML]] allein ist dazu **nicht** in der Lage
- Statt [[wiki/PHP\|PHP]] werden auch häufig **Perl** und **Python** eingesetzt

> [!important]  
> Ohne [[wiki/PHP\|PHP]] wären Websites nur statisch – mit [[wiki/PHP\|PHP]] werden sie **dynamisch**!
...
> Einfach: Es wird der auf dem [[wiki/Server\|Server]] gespeicherte Inhalt an den Browser übertragen.

**Wie ein Buch**: Immer der gleiche Inhalt, egal wer es liest.

### Dynamische Webseiten

> Hier kommt [[wiki/LAMP Stack\|LAMP Stack]] ins Spiel! 🎯

**Der Workflow:**

1. **Apache** bekommt eine [[wiki/PHP\|PHP]]-Abfrage → leitet sie an [[wiki/PHP\|PHP]] weiter
2. **[[wiki/PHP\|PHP]]** führt das geforderte Skript aus → fragt Daten per [[wiki/SQL\|SQL]] aus der [[wiki/Datenbank\|Datenbank]] ab
3. **[[wiki/PHP\|PHP]]** bearbeitet die Daten → gibt das Ergebnis an **Apache** weiter
...
|**MySQL**|[[wiki/Datenbank\|Datenbank]]|Das Gedächtnis/Lager|
...
> - Eine einsatzbereite [[wiki/Datenbank\|Datenbank]] (MySQL)
