---
{"dg-publish":true,"permalink":"/wiki/java-list/","tags":["informatik/software"],"noteIcon":"","updated":"2026-07-19T03:56:26.000+02:00","dg-note-properties":{"aliases":["Java List","java List"],"created_date":"2024-10-26","links":null,"tags":["informatik/software"]}}
---

>[!summary] Regeln
>- Eine [[wiki/Java List\|Java List]] ist eine dynamische Datenstruktur, die ihre Größe während der Laufzeit anpassen kann.
>- Im Gegensatz zu [[wiki/Java Array\|Java Array]] können Elemente in einer [[wiki/Java List\|Java List]] unterschiedlichen [[Datentypen\|Datentypen]] angehören.
>- **Unterschiede zu [[wiki/Java Array\|Java Array]]**:
>  - **Größe**: [[wiki/Java Array\|Java Array]] hat eine feste Größe, während [[wiki/Java List\|Java List]] dynamisch ist und ihre Größe anpassen kann.
>  - **Datentypen**: Alle Elemente in einem [[wiki/Java Array\|Java Array]] müssen denselben [[wiki/Datentyp\|Datentyp]] haben, während eine [[wiki/Java List\|Java List]] unterschiedliche Datentypen speichern kann.
>  - **Methoden**: [[wiki/Java Array\|Java Array]] hat keine eingebauten Methoden zur Bearbeitung von Elementen, während [[wiki/Java List\|Java List]] viele nützliche Methoden wie `add()`, `remove()`, und `size()` bietet.
...
## Neuer Wert für Element einsetzen
>[!example] Neuer Wert für Element einsetzen
```java
import java.util.ArrayList;
