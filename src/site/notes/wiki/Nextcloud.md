---
{"dg-publish":true,"permalink":"/wiki/nextcloud/","tags":["informatik/system","ausbildung/gfn"],"noteIcon":"","updated":"2026-07-19T03:56:26.983+02:00","dg-note-properties":{"tags":["informatik/system","ausbildung/gfn"],"aliases":null,"links":null,"created_date":"2025-09-05"}}
---

> **Nextcloud** ist eine freie Cloud-Software, die deine eigene "Dropbox" auf dem eigenen [[wiki/Server\|Server]] macht.
...
- **Weboberfläche** in [[wiki/PHP\|PHP]]
- Läuft in jedem Browser
- Mobile Apps verfügbar

**Backend/[[wiki/Datenbank\|Datenbank]]:**

- [[SQLite\|SQLite]] (für kleine Setups)
- [[wiki/MariaDB\|MariaDB]], [[MySQL\|MySQL]] oder [[PostgreSQL\|PostgreSQL]] (für größere Installationen)
...
1. **Nextcloud-[[wiki/Server\|Server]]** – das Herzstück mit deinen Daten
2. **[[wiki/Datenbank\|Datenbank]]-[[wiki/Server\|Server]]** – speichert Metadaten und Einstellungen
...
- **Verschlüsselung** der Daten auf dem [[wiki/Server\|Server]]
...
- **Monitoring** der [[wiki/Server\|Server]]-Performance
- **Automatisierte Backups**
- **App-Store** für Erweiterungen

> [!important] Im Gegensatz zu Google Drive oder Dropbox **gehören dir deine Daten** – sie verlassen niemals deinen [[wiki/Server\|Server]].
...
|**Kosten**|Nur [[wiki/Server\|Server]]-Kosten|Abo-Gebühren|Abo-Gebühren|
...
*abhängig von deiner [[wiki/Server\|Server]]-Festplatte

> [!warning] **Aber**: Du musst den [[wiki/Server\|Server]] selbst **warten**, **updaten** und **sichern**. Bei Google Drive macht das Google für dich.
...
- **[[wiki/RAM\|RAM]]**: 512 MB (besser: 2+ GB)
- **Festplatte**: Je nach Datenvolumen
- **[[wiki/PHP\|PHP]]**: Version 8.0+
- **Webserver**: [[Apache\|Apache]] oder [[Nginx\|Nginx]]
- **[[wiki/Datenbank\|Datenbank]]**: [[MySQL\|MySQL]]/[[wiki/MariaDB\|MariaDB]]/[[PostgreSQL\|PostgreSQL]]

### Empfohlenes Setup

- **[[wiki/Server\|Server]]** mit [[Linux\|Linux]] (Ubuntu/Debian)
- **[[SSL\|SSL]]-Zertifikat** für [[wiki/HTTPS\|HTTPS]]
- **Backup-Strategie** für Daten
- **[[wiki/Firewall\|Firewall]]** und Sicherheits-Updates

> [!success] Sobald installiert, hast du deine **eigene Cloud** – **für immer**, **ohne monatliche Kosten**.

---

> [!quote] Bottom Line **Nextcloud = Deine eigene Cloud auf deinem eigenen [[wiki/Server\|Server]].**  
