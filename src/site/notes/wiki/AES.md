---
{"dg-publish":true,"permalink":"/wiki/aes/","tags":["informatik/sicherheit/it-sicherheit","informatik/sicherheit/kryptografie/verschlüsselung","informatik/sicherheit/kryptografie/symmetrisch","algorithmus"],"noteIcon":"","updated":"2026-07-11T09:10:40.015+02:00","dg-note-properties":{"aliases":["Advanced Encryption Standard","AES-Verschlüsselung","Rijndael"],"created_date":"2024-08-04","links":null,"tags":["informatik/sicherheit/it-sicherheit","informatik/sicherheit/kryptografie/verschlüsselung","informatik/sicherheit/kryptografie/symmetrisch","algorithmus"]}}
---


> **AES** (Advanced Encryption Standard) ist ein [[wiki/Symmetrische Verschlüsselung\|symmetrischer Verschlüsselungsalgorithmus]], der Daten in Blöcken verschlüsselt und dabei den gleichen Schlüssel für [[wiki/Verschlüsselung\|Verschlüsselung]] und Entschlüsselung verwendet.
>> AES wurde von der US-Regierung als Standard für sichere Datenübertragung festgelegt und nutzt Blockgrößen von 128 [[wiki/Bit\|Bit]] mit Schlüssellängen von 128, 192 oder 256 [[wiki/Bit\|Bit]].
...
> Erst **alle** vier Operationen zusammen machen AES sicher — fällt eine weg, wird die Chiffre angreifbar.

| Baustein | Wenn er fehlt… |
|----------|----------------|
| **AddRoundKey** | Verschlüsselung wird **schlüsselunabhängig** → die restlichen Schritte sind öffentlich bekannt und umkehrbar |
| **SubBytes** | Chiffre bleibt **linear** → mit Known-Plaintext als lineares Gleichungssystem lösbar |
| **ShiftRows** | Spalten bleiben getrennt → jede Spalte lässt sich **separat** angreifen (32 statt 128 Bit) |
| **MixColumns** | keine Vermischung innerhalb der Spalten → jede Zelle einzeln angreifbar |
...
- [[wiki/Kryptographie\|Kryptographie]] - Übergeordnetes Konzept
- [[wiki/Symmetrische Verschlüsselung\|Symmetrische Verschlüsselung]] - AES ist symmetrisch
- [[wiki/RSA\|RSA]] - Asymmetrische Alternative
- [[wiki/TLS\|TLS]] - Verwendet AES für sichere Verbindungen
- [[wiki/Diffie-Hellman\|Diffie-Hellman]] - Schlüsselaustausch für AES
- [[wiki/Passwort-Hashing\|Passwort-Hashing]] - Schlüsselableitung für AES
