---
{"dg-publish":true,"permalink":"/wiki/strategy-pattern/","tags":["informatik/software","ausbildung/pruefung"],"noteIcon":"","updated":"2026-07-19T03:56:26.762+02:00","dg-note-properties":{"tags":["informatik/software","ausbildung/pruefung"],"aliases":["Strategy","Strategie-Pattern","Strategie-Muster"],"links":null,"created_date":"2025-11-05"}}
---


>Das [[wiki/Strategy Pattern\|Strategy Pattern]] erlaubt es dir, verschiedene Algorithmen austauschbar zu machen - du kannst zur Laufzeit entscheiden welchen Algorithmus du verwendest.
...
>[!quote] Definition
>Das [[wiki/Strategy Pattern\|Strategy Pattern]] definiert eine Familie von Algorithmen, kapselt jeden einzelnen und macht sie austauschbar.
...
- Verletzt [[wiki/OOP\|OOP]]-Prinzipien
...
>[!fail] Nachteile
>- **Mehr Klassen** - Jede Strategie ist eine eigene [[wiki/Java klasse\|Klasse]]
...
| Aspekt | [[wiki/Strategy Pattern\|Strategy Pattern]] | [[Factory Pattern\|Factory Pattern]] |
|--------|---------------------|---------------------|
| Zweck | Algorithmus austauschbar machen | [[wiki/Java Objekt\|Objekte]] erstellen |
| Wann wählen | Zur Laufzeit | Bei Erstellung |
| Fokus | Verhalten | Erzeugung |

### Strategy vs State Pattern

| Aspekt | [[wiki/Strategy Pattern\|Strategy Pattern]] | State Pattern |
|--------|---------------------|---------------|
...
- [[wiki/Design Patterns\|Design Patterns]] - Übergeordnetes Konzept
- [[Factory Pattern\|Factory Pattern]] - Erzeugungsmuster
- [[Observer Pattern\|Observer Pattern]] - Verhaltensmuster
- [[wiki/Singleton\|Singleton]] - Erzeugungsmuster
- [[wiki/OOP\|OOP]] - Objektorientierte Programmierung
- [[wiki/Polymorphie\|Polymorphie]] - Basis-Konzept für Strategy
- [[wiki/Java Interface\|Java Interface]] - Technische Umsetzung

## Zusammenfassung

>[!quote] Kern-Aussage
>Das [[wiki/Strategy Pattern\|Strategy Pattern]] macht Algorithmen austauschbar, indem es sie in separate Klassen kapselt und über ein gemeinsames [[wiki/Java Interface\|Interface]] zugänglich macht.
