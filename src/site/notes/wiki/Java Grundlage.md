---
{"dg-publish":true,"permalink":"/wiki/java-grundlage/","tags":["informatik/programmierung/sprachen/java"],"noteIcon":"","updated":"2026-05-12T15:30:18.000+02:00","dg-note-properties":{"aliases":["Java Grundlage","Java-Grundlage"],"created_date":"2024-11-02","links":null,"tags":["informatik/programmierung/sprachen/java"]}}
---


> Hier findest du die wichtigsten Java-Syntaxregeln, um die Sprache effektiv zu nutzen.

# [[wiki/Java klasse\|Java klasse]]

So wie bereits gesagt: [[wiki/Java\|Java]] ist eine [[wiki/OOP\|Objektorientierte Programmierung]]. Das heißt, alles ist ein Objekt in [[wiki/Java\|Java]] und muss in einer [[wiki/Java klasse\|Java Klasse]] definiert werden.
```java
public MyClass{
...
```
>[!summary] 
>[[wiki/Java klasse\|Java Klasse]]n können miteinander noch Kompositionen eingehen.
>Aber das lernst du später. Zuerst lass uns die Grundlagen lernen.

# [[wiki/Java Variable\|Java Variable]]

Wie in jeder Computersprache enthält [[wiki/Java\|Java]] [[wiki/Java Variable\|Java Variable]]n und ihre Syntax ist ganz ähnlich wie bei [[wiki/C Sprache\|C Sprache]].
Also man muss auf die [[wiki/Datentyp\|Datentyp]]en aufpassen wenn man [[wiki/Java Variable\|Java Variable]]n initialisiert oder deklariert.
...
```
>[!note] 
>Es ist dir vielleicht aufgefallen, aber das sind alle [[wiki/Primärdatentyp\|Primärdatentyp]]en. 
...
```
>[!note] 
>Das sind die [[wiki/Referenzdatentyp\|Referenzdatentyp]]en.
>> Genau gesagt: [[wiki/String\|String]] ist eine [[wiki/Klasse\|Klasse]].

# [[wiki/Java Array\|Java Array]]
...
```
>[!note] 
>Yep... In Java müssen wir ein [[wiki/Java Objekt\|Objekt]] erstellen für ein [[wiki/Java Array\|Java Array]].
# [[wiki/Java Bedingung\|Java Bedingung]]
[[wiki/IF-Bedingung\|IF-Bedingung]], [[wiki/ELSE IF-Bedingung\|ELSE IF-Bedingung]] und [[wiki/ELSE-Bedingung\|ELSE-Bedingung]] in Java.
```java
...
# [[wiki/Java Switch-Case\|Java Switch-Case]]
Stell dir mal vor, es wären die [[wiki/Java Bedingung\|Java Bedingung]]en, aber etwas präziser (wenn man mehr als eine [[wiki/IF-Bedingung\|IF-Bedingung]] hat).
```java
...
# [[wiki/Java Methode\|Java Methode]]
Eine [[wiki/Java Methode\|Java Methode]] ist ein Block von Code, der eine bestimmte Aufgabe ausführt. Methoden helfen, den Code zu organisieren und wiederverwendbar zu machen.
```java
...
(Man kann Variablen und Methoden benutzen ohne ein [[wiki/Java Objekt\|Java Objekt]] zu generieren).
```java
...
```
>[!note] Statische Mitglieder können ohne Erstellen einer Instanz der [[wiki/Klasse\|Klasse]] aufgerufen werden.
