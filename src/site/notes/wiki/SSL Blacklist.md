---
{"dg-publish":true,"permalink":"/wiki/ssl-blacklist/","tags":["informatik/sicherheit"],"noteIcon":"","updated":"2026-07-19T03:56:26.911+02:00","dg-note-properties":{"aliases":["SSLBL","SSL Blacklist abuse.ch"],"created":"2025-01-07","path":"Notes","tags":["informatik/sicherheit"]}}
---

> Datenbank von bösartigen SSL-Zertifikaten

**SSL Blacklist (SSLBL)** ist ein Service von [[wiki/abuse.ch\|abuse.ch]]. Er sammelt SSL-Zertifikate von [[wiki/Malware\|Malware]] und erstellt Blacklist.

---

## Was macht SSL Blacklist?

- **Sammelt SSL-Zertifikate**: Von [[wiki/Malware\|Malware]]-C&C-Servern
- **Erstellt Fingerprints**: SHA1-Hash der Zertifikate
- **Stellt Blacklist bereit**: Automatisch nutzbar
- **Erkennt [[wiki/Malware\|Malware]]**: Auch bei verschlüsseltem Traffic

## Warum wichtig?

**Problem:** [[wiki/Malware\|Malware]] nutzt HTTPS (SSL/TLS) zur Verschlüsselung
...
## Erkannte [[wiki/Malware\|Malware]]-Familien
...
- **Nur bekannte Zertifikate**: Neue [[wiki/Malware\|Malware]] wird erst nach Report erkannt
- **Zertifikats-Wechsel**: [[wiki/Malware\|Malware]] kann Zertifikate ändern
- **Shared Hosting**: Mehrere Domains auf einem Zertifikat

> [!tip] Ergänzende Maßnahme
> SSL Blacklist ist EINE Schicht in [[wiki/Defense in Depth\|Defense in Depth]]. Kombiniere mit [[wiki/URLhaus\|URLhaus]], [[wiki/Feodo Tracker\|Feodo Tracker]], und [[wiki/IDS\|IDS]]/[[wiki/IPS\|IPS]].
