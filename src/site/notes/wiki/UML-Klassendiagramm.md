...
>Ein [[wiki/UML-Klassendiagramm\|UML-Klassendiagramm]] zeigt die Struktur von Klassen in einem Programm. Es ist wie ein Bauplan für objektorientierte Software.

>>Mit einem [[wiki/UML-Klassendiagramm\|UML-Klassendiagramm]] siehst du, welche Klassen es gibt, was sie können und wie sie zusammenhängen.
...
>Diese [[wiki/Klasse\|Klasse]] können wir in einem [[wiki/UML-Klassendiagramm\|UML-Klassendiagramm]] darstellen, um eine bessere Übersicht zu haben.
...
>In [[wiki/UML\|UML]] gibt es verschiedene Arten von Verbindungen:
>
>1. **[[wiki/UML-Assoziation\|Assoziation]]** - "kennt" Beziehung
>2. **[[wiki/Vererbung\|Vererbung]]** - "ist ein" Beziehung
>3. **[[wiki/UML-Aggregation\|Aggregation]]** - "hat ein" Beziehung (lose)
>4. **[[wiki/UML-Komposition\|Komposition]]** - "hat ein" Beziehung (fest)
...
>[!note] Siehe: [[wiki/UML-Assoziation\|UML-Assoziation]] für Details
...
>[!note] Siehe: [[wiki/UML-Vererbung\|UML-Vererbung]] für Details
...
>[!note] Siehe: [[wiki/UML-Aggregation\|UML-Aggregation]] für Details
...
>[!note] Siehe: [[wiki/UML-Komposition\|UML-Komposition]] für Details
...
>[!note] Siehe: [[wiki/UML - Abstrakte Klassen\|UML - Abstrakte Klassen]] für Details
