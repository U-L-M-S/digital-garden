...
>- **Teil kann ohne Ganzes existieren** (Hauptunterschied zur [[wiki/UML-Komposition\|UML-Komposition]])
...
KOMPOSITION (gefüllte Raute)  → [[wiki/UML-Komposition\|UML-Komposition]]
┌────────┐           ┌────────┐
│ HAUS   │◆──────────│ ZIMMER │
└────────┘           └────────┘
