---
{"dg-publish":true,"permalink":"/wiki/lf-11-funktionalitaet-in-anwendungen-realisieren/","tags":["GFN/LF11"],"noteIcon":"","updated":"2025-09-16T14:40:37.000+02:00","dg-note-properties":{"tags":["GFN/LF11"],"links":"https://lernplattform.gfn.de/course/view.php?id=14381","created_date":"2024-09-16"}}
---
...
> 
> > Hier lernst du Algorithmen, [[wiki/Java\|Java]], Datenstrukturen und [[wiki/UML\|UML]] kennen. Das ist das Handwerkszeug für jeden Programmierer.
...
> 
> > Ohne Algorithmen könnte kein Programm funktionieren. Sie sind das Herz jeder [[wiki/Software\|Software]].

---

## [[wiki/Algorithmus\|Algorithmus]]

> Ein [[wiki/Algorithmus\|Algorithmus]] ist ein präzise festgelegtes Verfahren zur Lösung von Problemen. Wie ein Kochrezept, das aus endlich vielen Schritten besteht und in endlicher Zeit ein Ergebnis produziert.

### 5 Bedingungen für jeden [[wiki/Algorithmus\|Algorithmus]]:
...
# II. [[wiki/Java\|Java]] Entwicklungsumgebung

> [[wiki/Java\|Java]] ist plattformunabhängig - einmal geschrieben, läuft überall. Das macht die Sprache so beliebt für große [[wiki/Software\|Software]]-Projekte.
> 
> > Dafür brauchst du die richtige [[wiki/IDE\|IDE]] und verstehen, wie der [[wiki/javac\|javac]] funktioniert.

---

## [[wiki/Java\|Java]] [[wiki/IDE\|IDE]]

> Eine [[wiki/IDE\|IDE]] ist wie eine Werkbank für Programmierer - alles was du brauchst ist an einem Ort.

### Wichtige Komponenten:

- **JDK** - Java Development Kit - die komplette Werkzeugkiste
- **JRE** - Java Runtime Environment - damit laufen Java Programme
- **[[wiki/JVM\|JVM]]** - [[wiki/JVM\|Java Virtual Machine]] - übersetzt Bytecode in Maschinencode
- **Java [[wiki/Compiler\|Compiler]]** ([[wiki/javac\|javac]]) - macht aus Java-Code Bytecode

### Entwicklungsfluss:

1. **Quelle.java** - dein Java Code
2. **Java [[wiki/Compiler\|Compiler]]** ([[wiki/javac\|javac]]) - macht Bytecode draus (Quelle.class)
3. **[[wiki/JVM\|JVM]]** - führt Bytecode auf dem Zielsystem aus

> [!tip] Tipp NetBeans ist eine gute [[wiki/IDE\|IDE]] für Anfänger - hat alles integriert.
...
## [[wiki/Java klasse\|Java klasse]] und [[wiki/Java Objekt\|Java Objekt]]

> Klassen sind wie Baupläne, Objekte sind die fertigen Häuser. Eine Klassen beschreibt, was ein Objekt können soll.

### Aufbau einer [[wiki/Java klasse\|Java klasse]]:

- **Attributen** - Was das [[wiki/Java Objekt\|Java Objekt]] weiß (Eigenschaften)
- **[[wiki/Java Methode\|Java Methode]]** - Was das [[wiki/Java Objekt\|Java Objekt]] kann (Funktionen)
...
- Feste Größe, gleicher [[wiki/Datentyp\|Datentyp]]
...
# VI. [[wiki/UML\|UML]] Modellierung

> [[wiki/UML\|UML]] ist die Sprache der [[wiki/Software\|Software]]-Architekten. Bevor du programmierst, zeichnest du deine Ideen auf - das spart später viel Zeit.
> 
> > Mit [[wiki/UML\|UML]] können alle im Team verstehen, wie die [[wiki/Software\|Software]] aufgebaut ist.

---

## [[wiki/UML\|UML]] - [[wiki/UML\|Unified Modeling Language]]

> [[wiki/UML\|UML]] hat verschiedene Diagramme für verschiedene Sichten auf deine Software - wie ein Bauplan mit Grundriss, Seitenansicht und Elektroplan.

### Die 5 Sichten:

- **Logische Sicht** - [[wiki/UML-Klassendiagramm\|Klassendiagramme]], Paketdiagramme
- **Ablaufsicht** - [[wiki/UML-Sequenzdiagramme\|Sequenzdiagramme]], [[wiki/UML-Zustandsdiagramme\|Zustandsdiagramme]]
...
> [[wiki/UML-Klassendiagramm\|Klassendiagramme]] sind der Bauplan deiner Klassen - zeigen Eigenschaften, Funktionen und Beziehungen.
...
> [[wiki/UML-Sequenzdiagramme\|Sequenzdiagramme]] zeigen zeitliche Abläufe - wie ein Chat-Verlauf zwischen Objekten.
...
> Gute [[wiki/Software\|Software]] entsteht nicht durch Zufall - du brauchst Planung, Tests und modularen Aufbau.
> 
...
2. **Act** - [[wiki/Funktion\|Funktion]] ausführen
...
> Für professionelle [[wiki/Software\|Software]] brauchst du noch mehr Werkzeuge - Sortieralgorithmen, Komprimierung und [[wiki/Verschlüsselung\|Verschlüsselung]].
> 
...
- **Heapsort** - immer [[wiki/5. Big O(n log n)\|O(n log n)]], aber instabil
- **[[wiki/Quicksort\|Quicksort]]** - meist sehr schnell, schlimmstenfalls [[wiki/6. Big O(n²)\|O(n²)]]
- **Mergesort** - immer [[wiki/5. Big O(n log n)\|O(n log n)]], stabil aber braucht mehr [[wiki/Speicher\|Speicher]]
...
> [[wiki/Verschlüsselung\|Verschlüsselung]] schützt sensible Daten - vom Online-Banking bis zu privaten Nachrichten.

### Grundarten:

- **Symmetrisch** - Gleicher Schlüssel für Ver- und Entschlüsselung
- **Asymmetrisch** - Öffentlicher und privater Schlüssel ([[wiki/RSA\|RSA]])
- **Hash-Funktionen** - Einweg-[[wiki/Verschlüsselung\|Verschlüsselung]] für Passwörter

> [!warning] Sicherheit Niemals eigene [[wiki/Verschlüsselung\|Verschlüsselung]] entwickeln - nutze bewährte Bibliotheken!
