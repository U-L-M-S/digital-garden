...
>- Spalte, die auf [[wiki/Primary Key\|Primary Key]] einer anderen Tabelle zeigt
...
>[!note] Siehe auch
>- [[wiki/Primary Key\|Primary Key]] - Wird von FK referenziert
>- [[wiki/SQL JOIN\|SQL JOIN]] - Nutzt FK für Verknüpfungen
>- [[wiki/Normalisierung\|Normalisierung]] - Benötigt FK für Aufteilung