---
{"dg-publish":true,"permalink":"/wiki/uml/","tags":["ausbildung/gfn/ap2","GFN/prüfungsrelevant/AP2","informatik/uml"],"noteIcon":"","updated":"2026-07-02T15:36:34.000+02:00","dg-note-properties":{"aliases":["Unified Modeling Language","uml"],"created_date":"2024-09-26","links":null,"tags":["ausbildung/gfn/ap2","GFN/prüfungsrelevant/AP2","informatik/uml"]}}
---


>[[wiki/UML\|UML]] (Unified Modeling Language) ist eine Sprache, um Software zu zeichnen. Mit Bildern und Diagrammen zeigt man, wie ein Programm aufgebaut ist.

>>[[wiki/UML\|UML]] hilft, komplexe Software zu planen und zu dokumentieren. Es ist wie eine Bauzeichnung für Gebäude - nur für Programme.
...
>
>[[wiki/UML\|UML]] ist der "Bauplan" für Software!
>
>**Vorteile:**
...
>[[wiki/UML\|UML]] hat verschiedene Diagramm-Typen für verschiedene Zwecke.
...
>[!important] [[wiki/UML-Klassendiagramm\|UML-Klassendiagramm]]
>**Wofür?**
...
>```
>
>*Zeigt [[wiki/Vererbung\|Vererbung]], [[wiki/UML-Assoziation\|UML-Assoziation]]en zwischen Klassen*
>
>Siehe: [[wiki/UML-Klassendiagramm\|UML-Klassendiagramm]] für Details
...
>```
>
>Siehe: [[wiki/UML-Anwendungsfalldiagramm\|UML-Anwendungsfalldiagramm]] für Details

## 3. Aktivitätsdiagramm ⭐⭐⭐

>Zeigt Abläufe und Prozesse.

>[!important] [[wiki/UML-Aktivitätsdiagramm\|UML-Aktivitätsdiagramm]]
>**Wofür?**
...
>```
>
>Siehe: [[wiki/UML-Aktivitätsdiagramm\|UML-Aktivitätsdiagramm]] für Details
...
>```
>
>Siehe: [[wiki/UML-Sequenzdiagramme\|UML-Sequenzdiagramme]] für Details
...
>```
>
>Siehe: [[wiki/UML-Zustandsdiagramme\|UML-Zustandsdiagramme]] für Details
...
>→ [[wiki/UML-Zustandsdiagramme\|UML-Zustandsdiagramme]]
...
>So nutzt du [[wiki/UML\|UML]] im echten Projekt.
...
>Das musst du für die [[wiki/IHK\|IHK]]-Prüfung können.
...
> [!important]
> Dieses Thema kommt **immer** in der [[wiki/IHK\|IHK]]-Prüfung (Teil 2) vor. Also lerne es gut!

Es gibt verschiedene Arten von UML-Diagrammen, wie [[wiki/UML-Klassendiagramm\|Klassendiagramme]], [[wiki/UML-Anwendungsfalldiagramm\|Anwendungsfalldiagramme]], [[wiki/UML-Anwendungsdiagramm\|UML-Anwendungsdiagramm]], [[wiki/UML-Sequenzdiagramme\|UML-Sequenzdiagramme]] und [[wiki/UML-Zustandsdiagramme\|UML-Zustandsdiagramme]], die unterschiedliche Aspekte eines Systems abbilden.