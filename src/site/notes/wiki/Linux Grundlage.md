...
> - Perfekt für [[wiki/Server\|Server]]-Umgebungen

> [!info] Kostenlos
> 
> - Keine Lizenzkosten für das OS selbst
> - Support, Handbücher etc. können Geld [[wiki/Kosten\|kosten]]
> - Ideal für [[wiki/Unternehmen\|Unternehmen]] = weniger Ausgaben
...
> Eine **Distribution** = Linux-Kernel + Software-Paket + Paketmanager + [[wiki/GUI\|GUI]]
...
> - Hardware-Geräte
> - Prozesse
> - [[wiki/Netzwerk\|Netzwerk]]-Verbindungen
> - Konfiguration
...
> - **Embedded Systems:** [[wiki/Router\|Router]], Smart-TVs, Android
