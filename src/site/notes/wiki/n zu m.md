...
>>Beide Seiten der [[wiki/Relationship\|Relationship]] haben die Kardinalität "viele" - erfordert IMMER eine Zwischentabelle (Assoziationstabelle) zur Implementierung.

>[!summary] Kernpunkte
>Die **n:m-Beziehung** ist die komplexeste [[wiki/Relationship\|Relationship]]-Form:
>- Eine [[wiki/Entität\|Entität]] auf Seite A kann mit **vielen** [[wiki/Entität\|Entität]]en auf Seite B verbunden sein
>- Eine [[wiki/Entität\|Entität]] auf Seite B kann mit **vielen** [[wiki/Entität\|Entität]]en auf Seite A verbunden sein
...
>[!important]
>Nicht mit [[wiki/1 zu n\|1 zu n]] verwechseln! Bei 1:n braucht man KEINE Zwischentabelle, bei n:m ist sie ZWINGEND erforderlich!

## Verwandte Konzepte
- [[wiki/Relationship\|Relationship]] - Übergeordnetes Konzept
- [[wiki/1 zu 1\|1 zu 1]] - Eins-zu-eins-Beziehung
- [[wiki/1 zu n\|1 zu n]] - Eins-zu-viele-Beziehung
- [[wiki/Entität\|Entität]] - Objekte in Beziehungen
- [[wiki/ER-Modell\|ER-Modell]] - Entity-Relationship-Modell
- [[wiki/Foreign Key\|Foreign Key]] - Fremdschlüssel in Zwischentabelle
- [[wiki/Primary Key\|Primary Key]] - Primärschlüssel
