---
{"dg-publish":true,"permalink":"/wiki/entschluesselung/","tags":["informatik/sicherheit"],"noteIcon":"","updated":"2026-07-19T03:56:26.784+02:00","dg-note-properties":{"tags":["informatik/sicherheit"],"aliases":["decryption","entschlüsseln"],"links":null,"created_date":"2025-11-07"}}
---
...
>>Entschlüsselung ist das Gegenteil von [[wiki/Verschlüsselung\|Verschlüsselung]] - sie macht verschlüsselte Daten wieder lesbar.
...
### Bei [[wiki/Symmetrische Verschlüsselung\|symmetrischer Verschlüsselung]]
>Derselbe Schlüssel wird für [[wiki/Verschlüsselung\|Verschlüsselung]] und Entschlüsselung benutzt
...
**Beispiel:** [[wiki/AES\|AES]]
- Verschlüsselung: Klartext + Schlüssel → Geheimtext
- Entschlüsselung: Geheimtext + Schlüssel → Klartext

### Bei [[wiki/Asymmetrische Verschlüsselung\|asymmetrischer Verschlüsselung]]
...
Bei modernen Algorithmen wie [[wiki/AES\|AES]] oder [[wiki/RSA\|RSA]] ist es praktisch unmöglich, ohne den richtigen Schlüssel zu entschlüsseln:
- [[wiki/AES\|AES]]-256: $2^{256}$ mögliche Schlüssel (das sind mehr Möglichkeiten als Atome im Universum!)
- [[wiki/RSA\|RSA]]-2048: Faktoren zu finden würde tausende Jahre dauern
...
>Bei modernen Verschlüsselungen wie [[wiki/AES\|AES]]-256 oder [[wiki/RSA\|RSA]]-2048 ist es mit heutiger Technologie unmöglich, die Verschlüsselung in realistischer Zeit zu knacken.
>
...
>- **Webseiten öffnen:** Dein Browser entschlüsselt HTTPS-Verbindungen ([[wiki/TLS\|TLS]])
...
**Der Ablauf:**
1. **[[wiki/Verschlüsselung\|Verschlüsselung]]:** Klartext wird mit Schlüssel in Geheimtext verwandelt
...
## Vergleich: [[wiki/Verschlüsselung\|Verschlüsselung]] vs Entschlüsselung

| Eigenschaft | [[wiki/Verschlüsselung\|Verschlüsselung]] | Entschlüsselung |
|-------------|---------------------|-----------------|
...
>- **Lange Schlüssel:** Mindestens 128 Bit für symmetrisch, 2048 Bit für [[wiki/RSA\|RSA]]
>- **Moderne Algorithmen:** [[wiki/AES\|AES]], [[wiki/RSA\|RSA]], ECC
>- **Backup der Schlüssel:** Aber sicher aufbewahren!

## Verwandte Themen

- [[wiki/Verschlüsselung\|Verschlüsselung]] - Daten unlesbar machen
- [[wiki/Symmetrische Verschlüsselung\|Symmetrische Verschlüsselung]] - Ein Schlüssel für beides
- [[wiki/Asymmetrische Verschlüsselung\|Asymmetrische Verschlüsselung]] - Zwei Schlüssel System
- [[wiki/AES\|AES]] - Symmetrischer Standard-Algorithmus
- [[wiki/RSA\|RSA]] - Asymmetrischer Standard-Algorithmus
- [[wiki/TLS\|TLS]] - Verschlüsselung und Entschlüsselung im Internet
- [[wiki/Hash-Funktion\|Hash-Funktion]] - Einweg (keine Entschlüsselung möglich!)
