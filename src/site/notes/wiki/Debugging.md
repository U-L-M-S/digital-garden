---
{"dg-publish":true,"permalink":"/wiki/debugging/","tags":["informatik/programmierung","informatik/programmierung/fehlersuche","GFN/prüfungsrelevant/AP2"],"noteIcon":"","updated":"2026-07-02T13:17:19.715+02:00","dg-note-properties":{"tags":["informatik/programmierung","informatik/programmierung/fehlersuche","GFN/prüfungsrelevant/AP2"],"aliases":["debugging","Fehlersuche","Fehlerbehebung"],"links":null,"created_date":"2025-09-08"}}
---

>Debugging ist der Prozess, Fehler (Bugs) im Code zu finden und zu beheben.
>>Es ist eine der wichtigsten Fähigkeiten eines Entwicklers, systematisch Probleme zu analysieren und [[wiki/Methode\|Methode]]n zur Fehlerbehebung anzuwenden.
...
>
>**1. [[wiki/Print-Debugging\|Print-Debugging]]**
>- `System.out.println()` verwenden
>- Werte ausgeben und prüfen
>
>**2. [[wiki/Breakpoint\|Breakpoint]]-Debugging**
...
>```
>
>**Problem:** Programm stürzt ab mit `ArithmeticException` ([[wiki/Exception\|Exception]])
>
>**Debugging-Schritte:**
>
...
>
>3. **Fehler beheben** - Prüfung einbauen mit [[wiki/Try-Catch\|Try-Catch]]:
>```java
>int divisor = 0;
>if (divisor != 0) {
