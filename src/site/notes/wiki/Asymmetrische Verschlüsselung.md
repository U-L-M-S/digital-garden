---
{"dg-publish":true,"permalink":"/wiki/asymmetrische-verschluesselung/","tags":["ausbildung/pruefung","informatik/sicherheit"],"noteIcon":"","updated":"2026-07-19T03:56:26.972+02:00","dg-note-properties":{"tags":["ausbildung/pruefung","informatik/sicherheit"],"aliases":["asymmetric encryption"],"links":null,"created_date":"2024-07-16"}}
---
...
>Asymmetrische Verschlüsselung löst das größte Problem der [[wiki/Symmetrische Verschlüsselung\|symmetrischen Verschlüsselung]]: den [[Schlüsselaustausch\|Schlüsselaustausch]].
...
**2. [[wiki/Authentizität\|Authentizität]]:**
- Durch [[wiki/Digitale Signatur\|Digitale Signatur]]en wird die Identität des Absenders überprüft
- Reduziert Betrug und Identitätsdiebstahl
- Signatur mit Private Key, Prüfung mit Public Key

**3. [[wiki/Integrität\|Integrität]]:**
- [[wiki/Digitale Signatur\|Digitale Signatur]]en garantieren, dass Daten nicht manipuliert wurden
- Jede Änderung macht die Signatur ungültig
- Schafft Vertrauen in die [[wiki/Integrität\|Integrität]] der Informationen

**4. [[wiki/Nicht-Abstreitbarkeit\|Nicht-Abstreitbarkeit]]:**
...
>[[wiki/RSA\|RSA]] ist der bekannteste und am weitesten verbreitete asymmetrische Algorithmus. Benannt nach den Erfindern Rivest, Shamir und Adleman (1977).
...
>[[wiki/ECC\|ECC]] ist die moderne Alternative zu [[wiki/RSA\|RSA]]. Basiert auf elliptischen Kurven und bietet gleiche Sicherheit mit viel kürzeren Schlüsseln.
...
>- Löst das Hauptproblem der [[wiki/Symmetrische Verschlüsselung\|Symmetrische Verschlüsselung]]
>
>**2. Skalierbarkeit**
...
>- Beweist [[wiki/Authentizität\|Authentizität]] des Absenders
>- [[wiki/Nicht-Abstreitbarkeit\|Nicht-Abstreitbarkeit]] durch Private Key
>- Grundlage für [[wiki/PKI\|PKI]] und [[wiki/Zertifikat\|Zertifikat]]e
>
...
>
>**1. Extrem langsam**
>- 100-1000x langsamer als [[wiki/AES\|AES]]
...
>Fast ALLE praktischen Systeme kombinieren asymmetrische und [[wiki/Symmetrische Verschlüsselung\|Symmetrische Verschlüsselung]]: Asymmetrisch für Schlüsselaustausch, symmetrisch für Daten.
...
>[[wiki/ssh\|SSH]] verwendet asymmetrische Verschlüsselung für Authentifizierung.
...
>[[X.509\|X.509]]-[[wiki/Zertifikat\|Zertifikat]]e sind die Basis der Web-Sicherheit. Sie verbinden einen [[öffentlicher Schlüssel\|öffentlicher Schlüssel]] mit einer Identität.
...
- **Forward Secrecy** aktivieren ([[wiki/Diffie-Hellman\|Diffie-Hellman]], ephemeral keys)
...
- [[wiki/Symmetrische Verschlüsselung\|Symmetrische Verschlüsselung]] - Die Alternative mit einem Schlüssel
- [[wiki/RSA\|RSA]] - Der wichtigste asymmetrische Algorithmus
- [[wiki/ECC\|ECC]] - Moderne Alternative mit kürzeren Schlüsseln
- [[wiki/Digitale Signatur\|Digitale Signatur]] - Anwendung für Authentizität
- [[wiki/PKI\|PKI]] - Public Key Infrastructure
- [[wiki/Zertifikat\|Zertifikat]] - Verbindet Public Key mit Identität
- [[wiki/TLS\|TLS]] - Verwendet asymmetrische Verschlüsselung für Handshake
- [[wiki/Diffie-Hellman\|Diffie-Hellman]] - Schlüsselaustausch-Protokoll
...
>
>**Beste Wahl:** [[wiki/ECC\|ECC]] (Curve25519) oder RSA-2048+
>
...
>[!note] [[wiki/Symmetrische Verschlüsselung\|Symmetrische Verschlüsselung]] ist ein Good To Know ;D
