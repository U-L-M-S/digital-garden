---
{"dg-publish":true,"permalink":"/wiki/docker/","tags":["informatik/virtualisierung/docker","containerisierung"],"noteIcon":"","updated":"2026-05-13T08:44:49.000+02:00","dg-note-properties":{"aliases":["Docker","Container Platform","Docker Engine"],"created_date":"2024-09-04","links":null,"tags":["informatik/virtualisierung/docker","containerisierung"]}}
---
...
>>Löst das "auf meinem Computer funktioniert es aber" Problem durch einheitliche [[wiki/Docker Container\|Docker Container]] Umgebungen.
...
>Docker ist eine Software, die [[wiki/Docker Container\|Docker Container]] erstellt und verwaltet.
...
|---------|-------------|----------|
| **[[wiki/Dockerfile\|Dockerfile]]** | Anleitung wie das Image gebaut wird | Kochrezept |
| **[[wiki/Docker Image\|Docker Image]]** | Bauplan für den Container | Foto/Vorlage |
| **[[wiki/Docker Container\|Docker Container]]** | Laufende Instanz vom Image | Laufendes Programm |
| **[[wiki/Docker Registry\|Docker Registry]]** | Sammlung von Images | App Store |
| **[[wiki/Docker Hub\|Docker Hub]]** | Öffentliche Registry | Public App Store |

---

# Docker vs Virtuelle Maschinen

| Aspekt | [[wiki/Docker Container\|Docker Container]] | [[wiki/Virtuelle Maschinen\|Virtuelle Maschinen]] |
|--------|---------------------|------------------------|
...
- **Docker Registry** - Speicher für Images (z.B. [[wiki/Docker Hub\|Docker Hub]])
...
**Lösung:** Verwende [[wiki/Docker Volumes\|Docker Volumes]] für persistente Daten!
...
- [[wiki/Docker\|Docker]] - Hauptnotiz
- [[wiki/Docker Image\|Docker Image]] - Container werden aus Images erstellt
- [[wiki/Docker Volumes\|Docker Volumes]] - Persistente Daten
- [[wiki/Docker Networking\|Docker Networking]] - Container-Kommunikation
- [[wiki/Docker Compose\|Docker Compose]] - Multi-Container Management
...
>**Docker Image**s sind Blaupausen oder Vorlagen für [[wiki/Docker Container\|Docker Container]] - wie Fotos, die nicht verändert werden können.
...
- [[wiki/Docker\|Docker]] - Hauptnotiz
- [[wiki/Docker Container\|Docker Container]] - Container werden aus Images erstellt
- [[wiki/Dockerfile\|Dockerfile]] - Images mit Dockerfile bauen
- [[wiki/Docker Registry\|Docker Registry]] - Images speichern und teilen
- [[wiki/Docker Hub\|Docker Hub]] - Öffentliche Image Registry
...
- [[wiki/Docker\|Docker]] - Hauptnotiz
- [[wiki/Docker Image\|Docker Image]] - Dockerfile erstellt Images
- [[wiki/Docker Container\|Docker Container]] - Images werden zu Containern
- [[wiki/Docker Compose\|Docker Compose]] - Orchestrierung mit docker-compose.yml
...
>**Docker Compose** orchestriert mehrere [[wiki/Docker Container\|Docker Container]] mit einer einzigen YAML Datei.
...
- [[wiki/Docker\|Docker]] - Hauptnotiz
- [[wiki/Docker Container\|Docker Container]] - Container-Verwaltung
- [[wiki/Docker Networking\|Docker Networking]] - Netzwerk zwischen Containern
- [[wiki/Docker Volumes\|Docker Volumes]] - Persistente Daten
- [[wiki/Dockerfile\|Dockerfile]] - Images für Services bauen
...
- [[wiki/Docker\|Docker]] - Hauptnotiz
- [[wiki/Docker Container\|Docker Container]] - Container brauchen Volumes
- [[wiki/Docker Compose\|Docker Compose]] - Volumes in Compose definieren
- [[wiki/Docker Networking\|Docker Networking]] - Volumes + Networking = Stack
...
>Multi-Host Networking für [[wiki/Docker Swarm\|Docker Swarm]]
...
- [[wiki/Docker\|Docker]] - Hauptnotiz
- [[wiki/Docker Container\|Docker Container]] - Container brauchen Networking
- [[wiki/Docker Compose\|Docker Compose]] - Automatisches Networking
- [[wiki/Docker Swarm\|Docker Swarm]] - Overlay Networks für Cluster
...
>[[wiki/Docker Registry\|Docker Registry]] ist eine Sammlung von [[wiki/Docker Image\|Docker Image]]s - wie ein App Store für [[wiki/Docker Container\|Docker Container]].
>>[[wiki/Docker Hub\|Docker Hub]] ist die öffentliche [[Registry\|Registry]], private [[Registries\|Registries]] für Firmen möglich.

>[!tip] Registry Typen
>- **Public** - [[wiki/Docker Hub\|Docker Hub]], frei zugänglich
...
- [[wiki/Docker\|Docker]] - Hauptnotiz
- [[wiki/Docker Image\|Docker Image]] - Images hochladen/herunterladen
- [[wiki/Docker Registry\|Docker Registry]] - Private Registries
- [[wiki/Dockerfile\|Dockerfile]] - Images bauen für Hub
...
- [[wiki/Docker\|Docker]] - Hauptnotiz
- [[wiki/Docker Compose\|Docker Compose]] - Für einzelne Hosts
- [[wiki/Docker Networking\|Docker Networking]] - Overlay Networks
- [[wiki/Docker Container\|Docker Container]] - Tasks in Swarm
...
- [[wiki/Containerisierung\|Containerisierung]] - Container-Technologie allgemein
- [[wiki/Kubernetes\|Kubernetes]] - Container-Orchestrierung
- [[wiki/Microservices\|Microservices]] - Architektur-Pattern
