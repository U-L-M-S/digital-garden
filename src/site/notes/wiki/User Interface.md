---
{"dg-publish":true,"permalink":"/wiki/user-interface/","tags":["ausbildung/gfn","informatik/software"],"noteIcon":"","updated":"2026-07-19T03:56:27.008+02:00","dg-note-properties":{"aliases":["Benutzeroberflächen","User-Interface","user-interface"],"created_date":"2024-08-27","links":null,"tags":["ausbildung/gfn","informatik/software"]}}
---
...
Die Eingabe ermöglicht die Kommunikation des Nutzers mit dem Gerät. Theoretisch ist ein Gerät ohne Eingabe möglich, aber es gibt dann keine Möglichkeit, eine [[wiki/dynamic\|dynamische]] Ausgabe zu haben. Wie bereits gesagt, ist die Ausgabe die Kommunikation des Geräts mit dem Nutzer.
...
Achtet bitte darauf, dass dies zu vielen Problemen in der Benutzerschnittstelle führen kann, wenn die [[wiki/UI\|UI]] nicht intuitiv ist.

>[!summary] 
>Okay. Lass uns zusammenzufassen.
>Jeder Gerät/[[wiki/Software\|Software]] besitzt eine Benutzerschnittstelle. Diese können enthalten:
>- Eingabe
>- Ausgabe
>- Eingabe & Ausgabe
...
>![LF10 Benutzerschnittstellen gestalten und entwickeln-20240827002824359.png](/img/user/assets/IMG/LF10%20Benutzerschnittstellen%20gestalten%20und%20entwickeln-20240827002824359.png)
...
>![LF10 Benutzerschnittstellen gestalten und entwickeln-20240827003945993.png](/img/user/assets/IMG/LF10%20Benutzerschnittstellen%20gestalten%20und%20entwickeln-20240827003945993.png)
...
>[!tip]  Graphical user interface ([[wiki/GUI\|GUI]])
>![LF10 Benutzerschnittstellen gestalten und entwickeln-20240827004807000.png](/img/user/assets/IMG/LF10%20Benutzerschnittstellen%20gestalten%20und%20entwickeln-20240827004807000.png)
...
>![LF10 Benutzerschnittstellen gestalten und entwickeln-20240827005332750.png](/img/user/assets/IMG/LF10%20Benutzerschnittstellen%20gestalten%20und%20entwickeln-20240827005332750.png)
...
>![User Interface-20240827215259892.png](/img/user/assets/IMG/User%20Interface-20240827215259892.png)
>>Weiterentwicklung des [[wiki/GUI\|GUI]]s.
>>>- Handgestensteuerung
...
>[!summary] 
>Wie bereits gesagt, ist die [[wiki/GUI\|GUI]] in unserer heutigen Zeit am weitesten verbreitet.
>
