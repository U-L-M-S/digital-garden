---
{"dg-publish":true,"permalink":"/wiki/next-generation-firewall/","tags":["informatik/sicherheit"],"noteIcon":"","updated":"2026-07-19T03:56:26.970+02:00","dg-note-properties":{"aliases":["NGFW","Generation 3 Firewall","Application-Aware Firewall"],"created":"2025-01-07","path":"Notes","tags":["informatik/sicherheit"]}}
---
...
### 1. [[wiki/Deep Packet Inspection\|Deep Packet Inspection]] (DPI)
...
### 3. [[wiki/IDS\|IDS]]/[[wiki/IPS\|IPS]]

- Erkennt Angriffsmuster
- Blockiert automatisch bekannte Exploits
- Integration von Regel-Sets (ET Open, [[wiki/abuse.ch\|abuse.ch]])

### 4. Threat Intelligence

- Nutzt externe Datenbanken
- Blockiert bekannte [[wiki/Malware\|Malware]]-IPs automatisch
- Tägliche Updates
...
| **IP/Port-Filter** | ✓ | ✓ | ✓ |
| **Stateful** | ✗ | ✓ | ✓ |
| **[[wiki/Deep Packet Inspection\|Deep Packet Inspection]]** | ✗ | ✗ | ✓ |
...
- **Open-Source:**
  - [[wiki/OpenSense\|OpenSense]] mit [[wiki/Suricata\|Suricata]]
  - pfSense mit Snort
...
> NGFWs sind heute Standard in Unternehmen. Sie ersetzen [[wiki/Stateful Inspection Firewall\|Stateful Inspection Firewall]] + separates [[wiki/IDS\|IDS]]/[[wiki/IPS\|IPS]].
