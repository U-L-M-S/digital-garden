...
>>Interfaces ermöglichen [[Polymorphismus\|Polymorphismus]] und Multiple Inheritance (Mehrfachvererbung von Verhalten), da eine [[wiki/Klasse\|Klasse]] mehrere Interfaces implementieren kann.

>[!important] Wichtig
>Bei [[wiki/Java Vererbung\|Java Vererbung]] kann eine Child-[[wiki/Klasse\|Klasse]] nur von **einer** Parent-[[wiki/Klasse\|Klasse]] erben.
>Mit **Interfaces** kann eine [[wiki/Klasse\|Klasse]] **mehrere Interfaces** implementieren und somit Mehrfachvererbung simulieren.
...
>- Definiert **was** eine [[wiki/Klasse\|Klasse]] können muss
...
>[!warning] Wichtig
>Eine [[wiki/Klasse\|Klasse]], die ein Interface implementiert, **MUSS alle Methoden** des Interfaces überschreiben, sonst gibt es einen Compiler-Fehler.
...
| Eigenschaft | **Interface** | **[[wiki/Java abstrakte Klasse\|Java abstrakte Klasse]]** |
|-------------|--------------|-------------------------------|
...
>In [[wiki/UML-Klassendiagramm\|UML-Klassendiagramm]]en werden Interfaces mit `<<interface>>` gekennzeichnet.
...
**Siehe auch:**
- [[wiki/Java abstrakte Klasse\|Java abstrakte Klasse]]
