---
{"dg-publish":true,"permalink":"/wiki/server-grundlagen/","tags":["ausbildung/gfn"],"noteIcon":"","updated":"2026-07-19T03:56:26.704+02:00","dg-note-properties":{"tags":["ausbildung/gfn"],"aliases":null,"links":null,"created_date":"2025-07-18"}}
---

> Bevor wir in das Thema gehen, frage ich dich: Was ist ein [[wiki/Server\|Server]]? Was macht er?

Viele Leute hören oft: "[[wiki/Server\|Server]]", "[[wiki/Server\|Server]] ist down", "mit dem [[wiki/Server\|Server]] verbinden".  
Aber was ist ein [[wiki/Server\|Server]] wirklich?

Einfach gesagt: Ein [[wiki/Server\|Server]] ist auch ein Computer, wie der, den du gerade benutzt.  
Der Unterschied: Ein [[wiki/Server\|Server]] arbeitet 24/7. Er ist dafür da, anderen Computern oder Geräten etwas zu geben oder zu helfen.

## CPU
![image-89.png](/img/user/assets/IMG/image-89.png)

Weil ein [[wiki/Server\|Server]] oft vielen Nutzern gleichzeitig helfen muss, braucht er stärkere Hardware als ein normaler Computer.  
Vor allem die CPU ist wichtig. [[wiki/Server\|Server]] haben oft 2 oder mehr CPUs.
...
## [[wiki/RAM\|RAM]]
![image-85.png](/img/user/assets/IMG/image-85.png)

> "Ein [[wiki/Server\|Server]] ist auch ein Computer, wie der, den du gerade benutzt." Behalt das im Hinterkopf.

Bevor wir weitermachen, lies bitte diese echte Geschichte, die wirklich passiert ist:

> [!cite] Belgien Wahl Bit-Flip  
> 2003 gab es in Belgien (Schaerbeek) einen Fall, bei dem eine Kandidatin plötzlich 4.096 Stimmen zu viel bekam. Ursache war ein sogenannter [[wiki/Bit\|Bit]]-Flip: Ein kosmisches Teilchen traf die Speicherzelle des Wahlcomputers und kippte ein [[wiki/Bit\|Bit]] von 0 auf 1. Dadurch wurde die Stimmenzahl falsch gezählt.  
...
Wie dein Rechner oder Handy besitzt auch ein [[wiki/Server\|Server]] [[wiki/RAM\|RAM]].  
Wie du in der spannenden Geschichte gelesen hast, dürfen [[wiki/Server\|Server]] einfach keine Fehler machen.  
Daher gibt es einen speziellen [[wiki/RAM\|RAM]]-Typ für [[wiki/Server\|Server]]: [[wiki/ECC RAM\|ECC RAM]].

Kurz gesagt: Dieses Teil existiert, um solche Fehler zu vermeiden. [[wiki/ECC RAM\|ECC RAM]] nutzt den [[wiki/Hamming Code(7,4)\|Hamming Code(7,4)]]-Algorithmus, um Bit-Flips (0 → 1 oder 1 → 0) zu erkennen und zu korrigieren. [[wiki/ECC RAM\|ECC RAM]] hat einen extra Speicherchip **nur** für diesen Zweck (daher immer ungerade Anzahl an Speicherchips/Modulen bei [[wiki/ECC RAM\|ECC RAM]]).

> [!note]  
> Du musst [[wiki/Hamming Code(7,4)\|Hamming Code(7,4)]] nicht verstehen (wie er funktioniert).  
> Du musst aber wissen, dass er existiert und bei [[wiki/ECC RAM\|ECC RAM]] verwendet wird 😊.

## HDDs: SAS
![image-90.png](/img/user/assets/IMG/image-90.png)

> Ein [[wiki/Server\|Server]] muss oft viele Daten schnell lesen und speichern.  
...
- **Dual-Porting**:  
  Zwei Systeme können gleichzeitig auf dieselbe [[wiki/HDD\|HDD]] zugreifen.  
...
> [!note] [[wiki/HDD\|HDD]] vs [[wiki/SSD\|SSD]]  
> "[[wiki/SSD\|SSD]] ist aber schneller und besser.  
> Warum werden sie nicht in Servern verwendet?" 🤓  
>
> Du hast voll recht! 
> [[wiki/HDD\|HDD]] ist standardmäßig besser als [[wiki/SSD\|SSD]].  
> Aber [[wiki/HDD\|HDD]]s sind stabiler, günstiger, und haben eine geringere Wahrscheinlichkeit für Datenverlust.  
> Deshalb wurde SAS in [[wiki/HDD\|HDD]]s als 'Booster' eingesetzt.

## Riser Cards
![image-91.png](/img/user/assets/IMG/image-91.png)

> Viele Server haben eine flache Bauweise.  
> Was heißt das?  
>> Das heißt so viel, dass ein [[wiki/Server\|Server]] so aufgebaut ist (Standard), damit man mit wenig oder keinem Aufwand andere Hardwareteile einsetzen kann.
...
![image-92.png](/img/user/assets/IMG/image-92.png)
...
- Beliebt bei kleinen [[wiki/Unternehmen\|Unternehmen]]
...
![image-93.png](/img/user/assets/IMG/image-93.png)
...
- **Bessere Organisation** → ideal für viele [[wiki/Server\|Server]] nebeneinander
...
![image-95.png](/img/user/assets/IMG/image-95.png)
...
- Jedes **Blade** ist eine **einzelne Platine** mit CPU, [[wiki/RAM\|RAM]], [[wiki/Netzwerk\|Netzwerk]] usw.
...
>Ja. Wie zu erwarten benötigen diese riesigen Maschinen Strom, und zwar VIEL Strom. Daher verbrauchen sie deutlich mehr Strom als ein Standard-PC: von 5 Watt ([[wiki/elektrische Leistung\|elektrische Leistung]]) bis 150 Watt, je nach Hardware-Teil.
...
> [!important]  
> "Ein [[wiki/Server\|Server]] arbeitet 24/7 – das ist sein Job."  
...
- [[wiki/Server\|Server]] haben oft **zwei Netzteile** oder besser gesagt: zwei [[wiki/Stromkreis\|Stromkreis]]e
...
### Modi der Redundanz
![image-97.png](/img/user/assets/IMG/image-97.png)
...
### Hotswap
![image-98.png](/img/user/assets/IMG/image-98.png)

> [[wiki/Server\|Server]] laufen oft **tagelang oder wochenlang** ohne Pause.  
...
> Du kannst sagen: **[[wiki/Redundanz\|Redundanz]] schützt** – **Hotswap repariert im Betrieb**


## [[wiki/USV\|USV]] – Schutz vor Stromausfall
![image-99.png](/img/user/assets/IMG/image-99.png)

> Eine **[[wiki/USV\|USV]] (Unterbrechungsfreie Stromversorgung)** schützt den Serverraum bei Stromproblemen.  
...
- Viele Systeme führen automatisch einen **sicheren Shutdown** aus, wenn die [[wiki/USV\|USV]] anspringt
...
## Server-Kühlung
![image-100.png](/img/user/assets/IMG/image-100.png)
...
- [[wiki/Server\|Server]] sollten **alle in die gleiche Richtung** stehen  
