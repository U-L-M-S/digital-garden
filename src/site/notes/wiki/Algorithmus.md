---
{"dg-publish":true,"permalink":"/wiki/algorithmus/","tags":["algorithmus","informatik/programmierung/algorithmen","GFN/prüfungsrelevant/AP2"],"noteIcon":"","updated":"2026-07-02T13:17:19.000+02:00","dg-note-properties":{"aliases":["Algo","algorithmus"],"created_date":"2024-10-21","links":null,"tags":["algorithmus","informatik/programmierung/algorithmen","GFN/prüfungsrelevant/AP2"]}}
---


>Ein [[wiki/Algorithmus\|Algorithmus]] ist eine genaue Schritt-für-Schritt-Anleitung, um ein Problem zu lösen.

>>Jeder [[wiki/Algorithmus\|Algorithmus]] hat eine Eingabe (Input), verarbeitet diese nach festen Regeln und liefert eine Ausgabe (Output).

# I. Was ist ein Algorithmus?

>Ein [[wiki/Algorithmus\|Algorithmus]] ist wie ein Kochrezept - eine klare Anleitung.
...
>
>Das ist ein [[wiki/Algorithmus\|Algorithmus]] für Tee kochen!
...
>Ein guter [[wiki/Algorithmus\|Algorithmus]] braucht diese drei Eigenschaften.
...
>**Der [[wiki/Algorithmus\|Algorithmus]] muss irgendwann fertig sein.**
>
>Keine Endlos-Schleifen!
>- Der [[wiki/Algorithmus\|Algorithmus]] darf nicht für immer laufen
...
>**Ein [[wiki/Algorithmus\|Algorithmus]] braucht Daten zum Verarbeiten.**
>
>**Eingabe (Input):**
>- Daten, die der [[wiki/Algorithmus\|Algorithmus]] bekommt
...
>So sehen [[wiki/Algorithmus\|Algorithmen]] in der Praxis aus.
...
>
>**[[wiki/Algorithmus\|Algorithmus]] (Bubble Sort vereinfacht):**
>```
...
>[[wiki/Algorithmus\|Algorithmen]] kann man auf verschiedene Arten aufschreiben.
...
>
>**3. Programmiersprache ([[wiki/Java\|Java]]):**
>```java
...
>
>**Hinweis:** Dies ist eine [[wiki/Methode\|Methode]] in Java
>
>**4. Flussdiagramm:**
>```
>┌─────────┐
...
>Ein komplexerer [[wiki/Algorithmus\|Algorithmus]] aus der Praxis.
...
>Nicht alle [[wiki/Algorithmus\|Algorithmen]] sind gleich schnell.

>[!note] Performance verstehen
>**Einfacher [[wiki/Algorithmus\|Algorithmus]] (schnell):**
>```
...
>```
>
>**Mittlerer [[wiki/Algorithmus\|Algorithmus]]:**
>```
...
>```
>
>**Komplexer [[wiki/Algorithmus\|Algorithmus]] (langsam):**
>```
>Bubble Sort:
...
>[!warning] Typische Fehler beim [[wiki/Algorithmus\|Algorithmus]]-Design
>**1. Endlos-Schleifen:**
>```
>❌ FALSCH:
...
>Was du für die [[wiki/IHK\|IHK]]-Prüfung wissen musst.

>[!important] Prüfungsrelevant
>**Definition:**
>Ein [[wiki/Algorithmus\|Algorithmus]] ist eine eindeutige, endliche Folge von Anweisungen zur Lösung eines Problems.
>
