...
>>Sie definiert, wie [[wiki/Entität\|Entität]]en miteinander in Beziehung stehen (z.B. "Student belegt Kurs", "Person besitzt Auto").

>[!summary] Kernpunkte
>Eine **Relationship** (Beziehung) ist das Verbindungselement im **Entity-Relationship-Modell**:
>- Verbindet zwei oder mehr [[wiki/Entität\|Entität]]en miteinander
>- Wird durch **Kardinalitäten** spezifiziert ([[wiki/1 zu 1\|1 zu 1]], [[wiki/1 zu n\|1 zu n]], [[wiki/n zu m\|n zu m]])
...
>- **Rechteck** = [[wiki/Entität\|Entität]]
>- **Oval** = Attribut
>
>**Kardinalitäten:**
>- **1:1** → [[wiki/1 zu 1\|1 zu 1]] (eins-zu-eins)
>- **1:n** → [[wiki/1 zu n\|1 zu n]] (eins-zu-viele)
>- **n:m** → [[wiki/n zu m\|n zu m]] (viele-zu-viele, braucht Zwischentabelle!)
>
...
## Verwandte Konzepte
- [[wiki/Entität\|Entität]] - Objekte, die in Beziehung stehen
...
- [[wiki/Primary Key\|Primary Key]] - Primärschlüssel der Entitäten
