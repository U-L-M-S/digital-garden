...
KOMPOSITION ("HAS-A" Beziehung)  → [[wiki/UML-Komposition\|UML-Komposition]]
┌────────────────────────────────┐
│  class Auto {                  │
│    Motor motor;  // HAS-A      │
│  }                             │
...
## Verwandte Konzepte
- [[wiki/UML-Assoziation\|UML-Assoziation]] - Andere UML-Beziehung
- [[wiki/UML-Komposition\|UML-Komposition]] - HAS-A Beziehung
- [[wiki/UML-Aggregation\|UML-Aggregation]] - Schwache HAS-A Beziehung
...
- [[wiki/Methode\|Methode]] - Werden vererbt und überschrieben
