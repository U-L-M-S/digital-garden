---
{"dg-publish":true,"permalink":"/wiki/third-level-support/","tags":["it-service/support","GFN/LF06"],"noteIcon":"","updated":"2025-11-05T13:13:16.000+01:00","dg-note-properties":{"tags":["it-service/support","GFN/LF06"],"aliases":["3rd Level Support","Level 3 Support","L3 Support","Vendor Support"],"links":null,"created_date":"2025-11-05"}}
---


>[[wiki/Third-Level-Support\|Third-Level-Support]] ist die höchste Eskalationsstufe - die Profis vom Hersteller oder Entwickler-Team die selbst den härtesten Nüssen auf den Grund gehen.

>>Wenn auch [[wiki/Second-Level-Support\|Second-Level-Support]] kapituliert, kommt L3 ins Spiel - mit Zugriff auf Source Code und Hersteller-Insider-Wissen.

## Definition

>[!quote] Was ist [[wiki/Third-Level-Support\|Third-Level-Support]]?
>[[wiki/Third-Level-Support\|Third-Level-Support]] (L3) ist die höchste Eskalationsstufe die schwerwiegendste technische Probleme löst, Software-Bugs behebt und direkten Herstellerkontakt hat.
...
- Cisco Support für [[wiki/Router\|Router]]-Firmware
...
**Beispiele:**
- Firmware-Bug in [[wiki/Server\|Server]]-Mainboard
- [[wiki/SAN\|SAN]]-Controller-Fehler
...
- Proaktives [[wiki/Monitoring\|Monitoring]]
...
- [[wiki/First-Level-Support\|First-Level-Support]] - Erste Stufe
- [[wiki/Second-Level-Support\|Second-Level-Support]] - Zweite Stufe
- [[wiki/Eskalation\|Eskalation]] - Prozess zu L3
- [[wiki/Problem Management\|Problem Management]] - Strukturierte Fehler-Analyse
- [[Change Management\|Change Management]] - Wenn L3 Patches ausliefert

## Zusammenfassung

>[!quote] Kern-Aussage
>[[wiki/Third-Level-Support\|Third-Level-Support]] ist die höchste Eskalation für schwerste technische Probleme - meist Hersteller oder Entwickler mit Zugriff auf Source Code.
