---
{"dg-publish":true,"permalink":"/wiki/symmetrische-verschluesselung/","tags":["ausbildung/gfn/ap1/vorbereitung","informatik/sicherheit/it-sicherheit","informatik/sicherheit/kryptografie","informatik/sicherheit/kryptografie/verschlüsselung","informatik/sicherheit/kryptografie/symmetrisch"],"noteIcon":"","updated":"2026-07-02T15:37:49.000+02:00","dg-note-properties":{"tags":["ausbildung/gfn/ap1/vorbereitung","informatik/sicherheit/it-sicherheit","informatik/sicherheit/kryptografie","informatik/sicherheit/kryptografie/verschlüsselung","informatik/sicherheit/kryptografie/symmetrisch"],"aliases":["symmetric encryption","shared-key encryption","geheimer Schlüssel"],"links":null,"created_date":"2024-11-02"}}
---
...
>>Stell dir vor, du und dein Freund habt denselben Tresor-Code - wer den Code kennt, kann den Tresor öffnen UND verschließen. Genau so funktioniert symmetrische [[wiki/Kryptographie\|Kryptographie]].

# I. Das Grundprinzip

>Bei [[wiki/Symmetrische Verschlüsselung\|symmetrischer Verschlüsselung]] gibt es nur EINEN [[Schlüssel\|Schlüssel]] für beide Richtungen: [[wiki/Verschlüsselung\|Verschlüsselung]] und [[wiki/Entschlüsselung\|Entschlüsselung]].
...
**1. [[wiki/Vertraulichkeit\|Vertraulichkeit]]:**
...
**2. [[wiki/Integrität\|Integrität]]:**
- Verschlüsselter Austausch erschwert Manipulation der Daten
- Sichert die [[wiki/Integrität\|Integrität]] der Informationen

**3. Schnelligkeit:**
- Nur ein [[Schlüssel\|Schlüssel]] und recheneffizienter [[wiki/Algorithmus\|Algorithmus]]
- Besonders nützlich für große Datenmengen
- 1000x schneller als [[wiki/Asymmetrische Verschlüsselung\|Asymmetrische Verschlüsselung]]
...
>XOR allein ist NICHT sicher! Moderne Algorithmen wie [[wiki/AES\|AES]] sind viel komplexer und verwenden multiple Runden mit Substitutionen, Permutationen und komplexen mathematischen Operationen.
...
| **Beispiele** | [[wiki/AES\|AES]], [[wiki/DES\|DES]] | [[ChaCha20\|ChaCha20]], [[wiki/RC4\|RC4]] |

# IV. Die wichtigsten Algorithmen

## [[wiki/AES\|AES]] - Der Goldstandard

>[[wiki/AES\|AES]] (Advanced Encryption Standard) ist der weltweit am meisten verwendete symmetrische Algorithmus. Wurde 2001 als US-Standard gewählt und gilt als unknackbar.
...
## [[wiki/DES\|DES]] und [[3DES\|3DES]] - Die Veteranen

>[[wiki/DES\|DES]] (Data Encryption Standard) war von 1977-2001 der Standard, ist aber heute unsicher wegen zu kurzer [[Schlüssel\|Schlüssel]].
...
>[[ChaCha20\|ChaCha20]] ist ein moderner [[Stream-Chiffre\|Stream-Chiffre]], der oft als Alternative zu [[wiki/AES\|AES]] verwendet wird, besonders auf mobilen Geräten.

**Vorteile von ChaCha20:**
- Sehr schnell auf CPUs ohne AES-Hardware-Beschleunigung
- Einfacher zu implementieren als [[wiki/AES\|AES]]
- Resistent gegen Timing-Angriffe
- Verwendet in [[wiki/TLS\|TLS]], [[wiki/WireGuard\|WireGuard]], [[wiki/ssh\|SSH]]

# V. Betriebsmodi - Wie verschlüsselt man mehr als einen Block?

>[[Block-Chiffre\|Block-Chiffre]]n wie [[wiki/AES\|AES]] verschlüsseln nur 128 Bit auf einmal. Aber was, wenn deine Datei mehrere Megabyte groß ist? Hier kommen [[Betriebsmodus\|Betriebsmodi]] ins Spiel.
...
>[[GCM\|GCM]] kombiniert [[CTR\|CTR]]-Modus mit Authentifizierung - du bekommst [[wiki/Vertraulichkeit\|Vertraulichkeit]] UND [[wiki/Integrität\|Integrität]]!
...
>
>**1. Geschwindigkeit**
>- [[wiki/AES\|AES]]-Hardware-Beschleunigung in modernen CPUs
>- Kann mehrere GB/s verschlüsseln
>- 1000x schneller als [[wiki/RSA\|RSA]]
>
>**2. Einfachheit**
>- Konzept ist einfach: Ein Schlüssel für beide Richtungen
>- Weniger mathematische Komplexität als [[wiki/Asymmetrische Verschlüsselung\|Asymmetrische Verschlüsselung]]
>
>**3. Bewährte Sicherheit**
>- [[wiki/AES\|AES]] seit 20+ Jahren ohne erfolgreiche Angriffe
...
>- Lösung: [[wiki/Diffie-Hellman\|Diffie-Hellman]] oder [[wiki/Asymmetrische Verschlüsselung\|Asymmetrische Verschlüsselung]]
>
...
>- Für digitale Signaturen: [[wiki/Asymmetrische Verschlüsselung\|Asymmetrische Verschlüsselung]] nötig
...
>Moderne Systeme kombinieren [[wiki/Symmetrische Verschlüsselung\|Symmetrische Verschlüsselung]] und [[wiki/Asymmetrische Verschlüsselung\|Asymmetrische Verschlüsselung]]: Das Beste aus beiden Welten!
...
>[[wiki/BitLocker\|BitLocker]], [[LUKS\|LUKS]], [[FileVault\|FileVault]] - alle verwenden [[wiki/AES\|AES]] für Festplattenverschlüsselung.

**Warum symmetrisch?**
- Muss Millionen Blöcke pro Sekunde ver-/entschlüsseln
- [[wiki/Asymmetrische Verschlüsselung\|Asymmetrische Verschlüsselung]] wäre viel zu langsam
...
>[[wiki/WireGuard\|WireGuard]], [[wiki/OpenVPN\|OpenVPN]], [[wiki/IPSec\|IPsec]] - alle verwenden symmetrische Verschlüsselung für den eigentlichen Datentunnel.
...
- **Nicht [[wiki/DES\|DES]] oder [[3DES\|3DES]]** verwenden (veraltet)
...
- [[wiki/Kryptographie\|Kryptographie]] - Hauptartikel
- [[wiki/Asymmetrische Verschlüsselung\|Asymmetrische Verschlüsselung]] - Die Alternative mit zwei Schlüsseln
- [[wiki/AES\|AES]] - Der wichtigste symmetrische Algorithmus
...
- [[wiki/Diffie-Hellman\|Diffie-Hellman]] - Lösung für Schlüsselaustausch
- [[wiki/TLS\|TLS]] - Verwendet Hybrid-Verschlüsselung
...
>[!note] [[wiki/Asymmetrische Verschlüsselung\|Asymmetrische Verschlüsselung]] ist ein Good To Know ;D
