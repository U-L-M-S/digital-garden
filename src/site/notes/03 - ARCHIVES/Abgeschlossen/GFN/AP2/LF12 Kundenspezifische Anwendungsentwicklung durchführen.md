---
{"dg-publish":true,"permalink":"/03-archives/abgeschlossen/gfn/ap-2/lf-12-kundenspezifische-anwendungsentwicklung-durchfuehren/","tags":["GFN/LF12"],"noteIcon":"","updated":"2025-09-16T14:27:21.000+02:00","dg-note-properties":{"tags":["GFN/LF12"],"links":["https://lernplattform.gfn.de/course/view.php?id=15358"],"created_date":"2024-12-02"}}
---
...
> Das Abschlussprojekt ist dein Nachweis, dass du eigenständig [[02 - RESOURCES/Notes/Software\|Software]] entwickeln oder Pflichtenhefe erstellen kannst.
> 
> > Es muss eine reale Arbeitsaufgabe aus deinem [[02 - RESOURCES/Notes/Betrieb\|Betrieb]] sein - keine erfundene Geschichte!

---

## Abschlussprojekt - Was ist das?

> Ein Projekt mit 80 Stunden [[02 - RESOURCES/Notes/Arbeitszeit\|Arbeitszeit]], das du komplett eigenständig durchführst.

Das Abschlussprojekt hat zwei mögliche Varianten:

- **[[02 - RESOURCES/Notes/Software\|Software]] erstellen/anpassen** - Planung, Kalkulation, Realisierung und Testing
- **[[02 - RESOURCES/Notes/Pflichtenheft\|Pflichtenheft]] entwickeln** - Anforderungsanalyse, Schnittstellen und Einführungsplanung
...
> [!important] Wichtig - Prüfungsrelevant Das Projekt muss eine **tatsächlich im [[02 - RESOURCES/Notes/Betrieb\|Betrieb]] zu leistende, reale Arbeitsaufgabe** sein!

---

# II. Projektantrag erstellen

> Der Projektantrag ist dein "Vertrag" mit der [[02 - RESOURCES/Notes/IHK\|IHK]] - hier legst du fest, was du machen willst.
> 
...
> Bevor du anfangen kannst, musst du der [[02 - RESOURCES/Notes/IHK\|IHK]] erklären, was du vorhast.
...
> [!tip] Tipp - Praktische Hinweise Lass dir vom Auftraggeber schriftlich bestätigen, dass das Projekt OK ist!
...
- **Projektplanung** - [[02 - RESOURCES/Notes/Zeit\|Zeit]]- und Ressourcenplanung
- **Projektdurchführung** - Was hast du gemacht?
- **Projektergebnisse** - Was ist rausgekommen?
- **Reflexion** - Was lief gut/schlecht?

> [!example] Beispiel - Praktische Anwendung Nutze die Word-Vorlage der [[02 - RESOURCES/Notes/IHK\|IHK]] - dann passt das Format automatisch!

---

# IV. Präsentation und Fachgespräch

> Die Präsentation ist deine Show - hier verkaufst du dein Projekt an die [[02 - RESOURCES/Notes/IHK\|IHK]]-Prüfer.
> 
...
- **[[02 - RESOURCES/Notes/Planungsphase\|Planungsphase]]** - Zeitplanung, Terminplanung, Ablaufplanung, Ressourcenplanung, Kalkulation
...
> [!warning] Warnung - Achtung bei Anwendung Die Prüfer hinterfragen **alles** - sei bereit, jede Entscheidung zu begründen!
...
### 2. [[02 - RESOURCES/Notes/Planungsphase\|Planungsphase]]:

- **Systemarchitektur** - Wie baust du es auf?
- **Datenmodell** - Welche Daten brauchst du?
- **[[02 - RESOURCES/Notes/User Interface\|User Interface]]** Design - Wie soll es aussehen?
- **Zeitplanung** - Wann machst du was?

### 3. Implementierungsphase:

- **Code schreiben** - Die eigentliche Programmierung
- **Versionskontrolle** - [[02 - RESOURCES/Notes/Git\|Git]] nutzen!
- **Code Reviews** - Qualität sicherstellen
- **[[02 - RESOURCES/Notes/Debugging\|Debugging]]** - Fehler finden und beheben
...
- **Deployment** - [[02 - RESOURCES/Notes/Software\|Software]] in [[02 - RESOURCES/Notes/Betrieb\|Betrieb]] nehmen
- **Schulung** - Benutzer einweisen
- **Übergabe** - Projekt dem Auftraggeber übergeben
- **Dokumentation** finalisieren

> [!success] Erfolgreich - Positive Ergebnisse  
