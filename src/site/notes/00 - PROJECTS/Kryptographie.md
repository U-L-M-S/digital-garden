---
{"dg-publish":true,"permalink":"/00-projects/kryptographie/","tags":["kryptografie","informatik/sicherheit"],"noteIcon":"","updated":"2025-11-07T10:00:11.566+01:00"}
---
...
| Stream-Chiffre | Verschlüsselt Daten Bit für [[02 - RESOURCES/Notes/Bit\|Bit]] oder [[02 - RESOURCES/Notes/Byte\|Byte]] für [[02 - RESOURCES/Notes/Byte\|Byte]] | ChaCha20 |

## [[02 - RESOURCES/Notes/AES\|AES]] - Der Standard

>[[02 - RESOURCES/Notes/AES\|AES]] (Advanced Encryption Standard) ist der beste Standard für [[02 - RESOURCES/Notes/Symmetrische Verschlüsselung\|Symmetrische Verschlüsselung]]. Man benutzt [[02 - RESOURCES/Notes/AES\|AES]] überall - von WLAN bis zu verschlüsselten Festplatten.
...
>- HTTPS-Verbindungen (zusammen mit [[02 - RESOURCES/Notes/TLS\|TLS]])
...
>[[02 - RESOURCES/Notes/RSA\|RSA]] ist das bekannteste asymmetrische Verfahren. [[02 - RESOURCES/Notes/RSA\|RSA]] basiert auf einem mathematischen Problem: Es ist sehr schwer, große Zahlen in ihre Primfaktoren zu zerlegen.
...
>ECC ist die moderne Alternative zu [[02 - RESOURCES/Notes/RSA\|RSA]]. ECC basiert auf elliptischen Kurven und braucht viel kürzere Schlüssel für dieselbe Sicherheit.

| Sicherheitslevel | [[02 - RESOURCES/Notes/RSA\|RSA]] Schlüssellänge | ECC Schlüssellänge |
|------------------|---------------------------|---------------------------|
...
| [[02 - RESOURCES/Notes/SHA-256\|SHA-256]] | 256 Bit | ✅ Sicher - weit verbreitet |
...
>[[02 - RESOURCES/Notes/Hash-Funktion\|Hash-Funktion]]en sind überall - oft ohne dass du es merkst. Sie schützen deine Passwörter und prüfen die Integrität von Daten.
...
2. Server berechnet Hash-Wert: [[02 - RESOURCES/Notes/SHA-256\|SHA-256]]("geheim123") = "a3f5b8..."
...
>HMAC (Hash-based Message Authentication Code) kombiniert eine [[02 - RESOURCES/Notes/Hash-Funktion\|Hash-Funktion]] mit einem geheimen Schlüssel. So garantiert man Integrität UND Authentizität.
...
- [[02 - RESOURCES/Notes/TLS\|TLS]]-Verbindungen für Integrität
- JWT (JSON Web Tokens)
...
**Unterschied zur Verschlüsselung:** Verschlüsselung hält Nachrichten geheim. [[02 - RESOURCES/Notes/Digitale Signatur\|Digitale Signatur]]en beweisen Authentizität und Integrität.
___
...
>Genau wie bei Verschlüsselung gibt es auch bei [[02 - RESOURCES/Notes/Digitale Signatur\|Digitale Signatur]]en verschiedene Algorithmen. Die wichtigsten sind RSA-Signatur und ECDSA.
...
>[!example] Beispiel: HTTPS-Verbindung
...
>Kryptographische Protokolle kombinieren verschiedene Verfahren (Verschlüsselung, [[02 - RESOURCES/Notes/Hash-Funktion\|Hash-Funktion]]en, [[02 - RESOURCES/Notes/Digitale Signatur\|Digitale Signatur]]en), um sichere Kommunikation zu ermöglichen.
...
>[[02 - RESOURCES/Notes/TLS\|TLS]] (früher SSL genannt) ist DAS Protokoll für sichere Internet-Verbindungen. Jede HTTPS-Website nutzt [[02 - RESOURCES/Notes/TLS\|TLS]].
...
>Das Diskreter Logarithmus-Problem ist die mathematische Basis für [[02 - RESOURCES/Notes/Diffie-Hellman\|Diffie-Hellman]] und ECC.
...
>- 256-Bit ECC ≈ 3072-Bit [[02 - RESOURCES/Notes/RSA\|RSA]]
...
## HTTPS und [[02 - RESOURCES/Notes/TLS\|TLS]] in der Praxis

>Jede moderne Website MUSS HTTPS benutzen. Ohne [[02 - RESOURCES/Notes/TLS\|TLS]] können Angreifer im WLAN alle Daten mitlesen.
...
- **Tunnel Mode** - Komplettes IP-Paket wird verschlüsselt (für VPNs)
...
- **[[02 - RESOURCES/Notes/Digitale Signatur\|Digitale Signatur]]** - Transaktionen werden mit ECDSA signiert
...
>2. Netzwerk prüft [[02 - RESOURCES/Notes/Digitale Signatur\|Digitale Signatur]] mit Alice's öffentlichem Schlüssel
...
>- **Kleine Schlüssel** - Mindestens 128 Bit für symmetrisch, 2048 Bit für [[02 - RESOURCES/Notes/RSA\|RSA]]
...
2. **[[02 - RESOURCES/Notes/Asymmetrische Verschlüsselung\|Asymmetrische Verschlüsselung]]** ([[02 - RESOURCES/Notes/RSA\|RSA]], ECC) = löst Schlüsselaustausch, aber langsam
...
4. **[[02 - RESOURCES/Notes/Digitale Signatur\|Digitale Signatur]]en** = beweisen Authentizität und Integrität
